...
const I18N = {
  es: {
    ...
    clause_nonsolicit_title_mutual: "NO CAPTACIÓN DE PERSONAL Y CLIENTES",
    clause_nonsolicit_body_mutual: "Durante la vigencia del presente Acuerdo y por un período de {duration} posterior a su terminación, ninguna de las Partes solicitará, contratará ni captará, directa o indirectamente, a empleados, contratistas o clientes de la otra Parte que hayan tenido relación con el objeto del presente Acuerdo, sin el consentimiento previo y por escrito de dicha Parte.",
    ...
    c2_title_nda_mutual: "SEGUNDA. DEFINICIÓN Y OBLIGACIONES DE CONFIDENCIALIDAD",
    c2_body_nda_mutual: "Para efectos del presente Acuerdo, se entenderá por «Información Confidencial» toda información técnica, comercial, financiera, operativa o de cualquier otra naturaleza que una Parte revele a la otra, ya sea de forma escrita, oral, visual o electrónica, que esté marcada como confidencial o que, por su naturaleza o las circunstancias de su divulgación, deba razonablemente entenderse como confidencial. Cada Parte, en su calidad de receptora de información, se obliga a: (i) mantener la información confidencial recibida en estricta reserva; (ii) no divulgarla a terceros sin autorización previa y por escrito de la Parte divulgante; (iii) no utilizarla para fines distintos a los establecidos en la Cláusula Primera; y (iv) adoptar las medidas de seguridad razonables para evitar su divulgación accidental o no autorizada.",
    ...
    c7_body: "El presente documento se regirá e interpretará de conformidad con las leyes vigentes en {jurisdiction}. Para la resolución de cualquier controversia derivada de su interpretación o cumplimiento, las Partes se someten a los tribunales competentes de dicha jurisdicción, con renuncia expresa a cualquier otro fuero que pudiera corresponderles. A falta de indicación expresa de la jurisdicción aplicable, se entenderá que rige la ley del domicilio de {roleA}.",
    ...
    c_remedies_title: "DÉCIMA. RECURSOS Y MEDIDAS CAUTELARES",
    c_remedies_body: "Las Partes reconocen que el incumplimiento de las obligaciones de confidencialidad establecidas en el presente Acuerdo puede ocasionar un daño irreparable a la Parte divulgante, para el cual una compensación económica podría no constituir un remedio adecuado. En consecuencia, la Parte divulgante tendrá derecho a solicitar medidas cautelares o de cumplimiento específico ante la autoridad competente, sin perjuicio de cualquier otro recurso que le corresponda conforme a derecho.",
  ...
  en: {
    ...
    clause_nonsolicit_title_mutual: "NON-SOLICITATION OF PERSONNEL AND CLIENTS",
    clause_nonsolicit_body_mutual: "During the term of this Agreement and for a period of {duration} following its termination, neither Party shall solicit, hire, or otherwise recruit, directly or indirectly, any employees, contractors, or clients of the other Party who have been involved with the subject matter of this Agreement, without such other Party's prior written consent.",
    ...
    c7_body: "This document shall be governed by and construed in accordance with the laws in force in {jurisdiction}. Any dispute arising from its interpretation or performance shall be submitted to the competent courts of that jurisdiction, with the Parties expressly waiving any other venue that might otherwise apply. In the absence of an express choice of jurisdiction, the laws of {roleA}'s domicile shall govern.",
    ...
    c_remedies_title: "TENTH. REMEDIES AND INJUNCTIVE RELIEF",
    c_remedies_body: "The Parties acknowledge that a breach of the confidentiality obligations set forth in this Agreement may cause irreparable harm to the disclosing Party, for which monetary damages alone may not constitute an adequate remedy. Accordingly, the disclosing Party shall be entitled to seek injunctive relief or specific performance from the competent authority, without prejudice to any other remedy available to it under applicable law.",
  ...
  de: {
    meta_title: "DraftB2B — Kostenloser B2B-Vertrags- und NDA-Generator",
    meta_description: "DraftB2B: Erstellen und laden Sie Ihre Geheimhaltungsvereinbarung (NDA), Ihren B2B-Dienstleistungsvertrag oder Ihre Datenschutzerklärung in Minuten als PDF herunter. Kostenlos, keine Registrierung erforderlich.",
    brand_name: "DraftB2B",
    nav_tool: "Generator",
    nav_guide: "Rechtsleitfaden",
    nav_faq: "FAQ",
    ad_label: "Werbung",
    ad_native: "Natives Werbeelement",
    hero_badge: "100% kostenlos · Keine Registrierung · Sofortiger Download",
    hero_title: "Suite für B2B-Handelsverträge und Rechtsvereinbarungen",
    hero_subtitle: "Erstellen, unterzeichnen und validieren Sie Geheimhaltungsvereinbarungen (NDA), Verträge und Rechtsdokumente in 8 Sprachen mit kryptografischer Verifizierung.",
    tpl_unilateral_title: "Einseitige Geheimhaltungsvereinbarung",
    tpl_unilateral_desc: "Eine Partei offenbart Informationen, die andere schützt sie.",
    tpl_mutual_title: "Gegenseitige (zweiseitige) Geheimhaltungsvereinbarung",
    tpl_mutual_desc: "Beide Parteien teilen und schützen Informationen.",
    tpl_b2b_title: "B2B-Dienstleistungsvertrag",
    tpl_b2b_desc: "Erbringung von Dienstleistungen zwischen Unternehmen.",
    tpl_unilateral_short: "Einseitig",
    tpl_mutual_short: "Gegenseitig",
    tpl_b2b_short: "B2B",
    btn_view_document: "Vorschau anzeigen",
    btn_edit_form: "Formular bearbeiten",

    // --- Optional / additional clauses ---
    optional_clauses_title: "Zusätzliche / Optionale Klauseln",
    optional_clauses_hint: "Aktivieren Sie die Klauseln, die Sie einschließen möchten. Sie werden automatisch mit der korrekten Nummerierung hinzugefügt.",
    toggle_noncompete_label: "Wettbewerbsverbot",
    toggle_noncompete_desc: "Verhindert, dass die empfangende Partei während der Vertragslaufzeit direkt konkurrierende Geschäfte betreibt.",
    toggle_nonsolicit_label: "Abwerbeverbot",
    toggle_nonsolicit_desc: "Untersagt die Abwerbung oder Einstellung von Mitarbeitern, Auftragnehmern oder Kunden der anderen Partei.",
    toggle_arbitration_label: "Schiedsverfahren statt Gerichte",
    toggle_arbitration_desc: "Ersetzt die übliche Gerichtsstandsklausel durch ein bindendes Handelsschiedsverfahren.",
    clause_noncompete_title: "WETTBEWERBSVERBOT",
    clause_noncompete_body: "Während der Laufzeit dieser Vereinbarung und für einen Zeitraum von {duration} nach deren Beendigung verpflichtet sich {roleB}, kein Unternehmen, Projekt oder keine Tätigkeit zu entwickeln, zu betreiben, sich daran zu beteiligen oder direkt oder indirekt daran mitzuwirken, das/die unmittelbar mit dem in der Ersten Klausel beschriebenen Gegenstand konkurriert, ohne die vorherige schriftliche Zustimmung von {roleA}.",
    clause_nonsolicit_title: "ABWERBEVERBOT VON PERSONAL UND KUNDEN",
    clause_nonsolicit_body: "Während der Laufzeit dieser Vereinbarung und für einen Zeitraum von {duration} nach deren Beendigung verpflichtet sich {roleB}, weder direkt noch indirekt Mitarbeiter, Auftragnehmer oder Kunden von {roleA}, die mit dem Gegenstand dieser Vereinbarung befasst waren, abzuwerben, einzustellen oder anderweitig zu rekrutieren, ohne die vorherige schriftliche Zustimmung von {roleA}.",
    clause_nonsolicit_title_mutual: "ABWERBEVERBOT VON PERSONAL UND KUNDEN",
    clause_nonsolicit_body_mutual: "Während der Laufzeit dieser Vereinbarung und für einen Zeitraum von {duration} nach deren Beendigung wird keine der Parteien direkt oder indirekt Mitarbeiter, Auftragnehmer oder Kunden der anderen Partei, die mit dem Gegenstand dieser Vereinbarung befasst waren, abwerben, einstellen oder anderweitig rekrutieren, ohne die vorherige schriftliche Zustimmung dieser anderen Partei.",
    clause_arbitration_title: "STREITBEILEGUNG - SCHIEDSVERFAHREN",
    clause_arbitration_body: "Jede Streitigkeit, die sich aus der Auslegung oder Erfüllung dieses Dokuments ergibt, wird endgültig durch ein bindendes Handelsschiedsverfahren mit Sitz in {jurisdiction} beigelegt, wobei die Parteien ausdrücklich auf die Anrufung ordentlicher Gerichte verzichten, mit Ausnahme der Vollstreckung des ergangenen Schiedsspruchs.",
    custom_clause_add_btn: "+ Benutzerdefinierte Klausel hinzufügen",
    custom_clause_title_label: "Titel der Klausel",
    custom_clause_title_placeholder: "Z. B. Geistiges Eigentum",
    custom_clause_body_label: "Inhalt der Klausel",
    custom_clause_body_placeholder: "Schreiben Sie den vollständigen Text der Klausel...",
    custom_clause_remove_btn: "Entfernen",
    custom_clause_empty_hint: "Sie haben noch keine benutzerdefinierten Klauseln hinzugefügt.",

    // --- Integrity seal (SHA-256 + QR) ---
    doc_hash_label: "Verifizierungs-Hash",
    doc_timestamp_label: "Digitaler Zeitstempel",
    doc_integrity_hint: "Dieses Siegel ermöglicht die Überprüfung, dass der Inhalt seit der Erstellung nicht verändert wurde.",

    // --- Watermark ---
    watermark_label: "Wasserzeichen",
    watermark_none: "Kein Wasserzeichen",
    watermark_draft: "ENTWURF",
    watermark_confidential: "VERTRAULICH",
    watermark_review: "PRÜFEXEMPLAR",

    // --- Share pre-filled link ---
    btn_share_link: "Mit Gegenpartei teilen",
    share_modal_title: "Formular teilen",
    share_modal_desc: "Teilen Sie diesen Link mit der anderen Partei. Er öffnet sich mit den bereits ausgefüllten Angaben Ihres Unternehmens; die Gegenpartei muss nur noch ihre eigenen ergänzen.",
    share_copy_btn: "Link kopieren",
    share_copied_msg: "Link in die Zwischenablage kopiert!",
    share_prefill_notice: "Wir haben die Angaben der Gegenpartei ausgefüllt. Bitte vervollständigen Sie Ihre Informationen als empfangende Partei.",
    share_success_title: "🎉 Dokument erfolgreich erstellt",
    share_success_message: "DraftB2B ist 100% kostenlos, privat und erfordert keine Registrierung. Wenn Ihnen dieses Tool Zeit erspart hat, helfen Sie uns, es bekannt zu machen, oder unterstützen Sie die Weiterentwicklung des Projekts.",
    share_success_btn_twitter: "Auf X / Twitter teilen",
    share_success_btn_kofi: "Spendieren Sie uns einen Kaffee (Ko-fi)",
    share_success_btn_close: "Schließen",

    // --- Penalty clause calculator ---
    penalty_calc_title: "Vertragsstrafen-Rechner",
    penalty_calc_desc: "Schätzen Sie einen Betrag und einen Formulierungsvorschlag für die Vertragsstrafenklausel bei Vertragsverletzung, basierend auf dem Wert Ihrer Informationen oder Ihres Projekts. Dies ist lediglich ein unverbindlicher Vorschlag, keine Rechtsberatung.",
    penalty_value_label: "Geschätzter Wert des Projekts / der Informationen",
    penalty_currency_label: "Währung",
    penalty_calc_btn: "Vorschlag berechnen",
    penalty_result_intro: "Unverbindlicher Vorschlag:",
    penalty_result_text: "Im Falle einer Vertragsverletzung wird eine Vertragsstrafe von etwa {amount} {currency} vorgeschlagen (entspricht 15% des angegebenen Werts), unbeschadet weiterer nachweisbarer Schäden.",
    penalty_insert_btn: "In den Vertrag einfügen",
    penalty_inserted_msg: "Vertragsstrafenklausel zu Ihren benutzerdefinierten Klauseln hinzugefügt.",
    penalty_clause_title: "SCHADENERSATZ BEI VERTRAGSVERLETZUNG",

    // --- Pre-download checklist ---
    checklist_title: "Kurze Checkliste vor dem Download",
    checklist_item1: "Ich habe die Identität beider Parteien überprüft",
    checklist_item2: "Der Umfang und Zweck sind klar definiert",
    checklist_item3: "Es besteht Einigkeit über den anwendbaren Gerichtsstand",
    checklist_hint: "Aktivieren Sie alle 3 Kontrollkästchen, um den Download zu ermöglichen.",

    wizard_section_heading: "Erstellen Sie Ihr Dokument",
    step1_label: "Parteien",
    step2_label: "Zweck",
    step3_label: "Dauer",
    step4_label: "Überprüfung",
    party_a_legend: "Offenlegende Partei",
    party_a_legend_mutual: "Erste Partei",
    party_a_legend_b2b: "Dienstleister",
    party_b_legend: "Empfangende Partei",
    party_b_legend_mutual: "Zweite Partei",
    party_b_legend_b2b: "Kunde",
    label_name: "Name / Unternehmen",
    label_taxid: "Steuernummer / Handelsregisternummer",
    label_address: "Anschrift",
    ph_name: "Z. B. Muster GmbH",
    ph_taxid: "Z. B. USt-IdNr. DE123456789",
    ph_address: "Z. B. Musterstraße 1, 10115 Berlin",
    label_object: "Zweck der vertraulichen Informationen",
    label_object_b2b: "Umfang und Zweck der Dienstleistung",
    ph_object: "Z. B. Bewertung einer möglichen Geschäftspartnerschaft zur gemeinsamen Entwicklung einer Softwareplattform...",
    object_hint: "Beschreiben Sie kurz, warum die Informationen ausgetauscht werden (Verhandlung, Zusammenarbeit, Dienstleistungserbringung usw.).",
    label_duration: "Dauer der Verpflichtung",
    label_duration_b2b: "Vertragslaufzeit / Dauer",
    opt_indefinite: "Unbefristet",
    label_jurisdiction: "Gerichtsstand und anwendbares Recht",
    ph_jurisdiction: "Z. B. Berlin, Deutschland",
    review_hint: "Überprüfen Sie die Live-Vorschau rechts. Sobald alles korrekt aussieht, laden Sie Ihr Dokument als PDF herunter oder kopieren Sie es in die Zwischenablage.",
    ...
    preview_title: "Vorschau in Echtzeit",
    preview_live: "Live",
    guide_h2_1: "Was ist eine Geheimhaltungsvereinbarung (NDA)?",
    guide_p_1: "Eine Geheimhaltungsvereinbarung (Non-Disclosure Agreement, NDA) ist ein rechtsverbindlicher Vertrag, in dem sich eine oder mehrere Parteien verpflichten, vertrauliche Informationen, die im Rahmen einer Verhandlung, Zusammenarbeit oder Geschäftsbeziehung ausgetauscht wurden, nicht offenzulegen, preiszugeben oder zum eigenen Vorteil zu nutzen. Sie ist ein unverzichtbares Instrument, bevor Geschäftspläne, Quellcode, Finanzdaten, Prototypen oder andere sensible Informationen an Dritte weitergegeben werden.",
    guide_h3_1: "Arten von NDAs: einseitig vs. gegenseitig",
    guide_p_2: "Bei einer <strong>einseitigen NDA</strong> gibt nur eine Partei (die „offenlegende Partei\") vertrauliche Informationen preis, während die andere (die „empfangende Partei\") die Pflicht übernimmt, diese zu schützen. Dieses Modell ist üblich, wenn ein Unternehmen Informationen mit einem Lieferanten, Bewerber oder potenziellen Investor teilt. Bei einer <strong>gegenseitigen oder zweiseitigen NDA</strong> tauschen beide Parteien vertrauliche Informationen miteinander aus und übernehmen beide Schutzpflichten, was bei Fusionen, Joint Ventures oder strategischen Allianzen üblich ist.",
    guide_h3_2: "Wesentliche Klauseln einer NDA",
    guide_p_clauses_intro: "Eine gut formulierte Geheimhaltungsvereinbarung sollte mindestens folgende Elemente enthalten:",
    guide_list_clauses: [
      "<strong>Definition der vertraulichen Informationen:</strong> welche Arten von Daten, Dokumenten oder Kenntnissen durch die Vereinbarung geschützt werden (technische, kaufmännische, finanzielle Informationen, Quellcode usw.).",
      "<strong>Ausnahmen:</strong> Informationen, die nicht als vertraulich gelten, weil sie öffentlich bekannt, der empfangenden Partei bereits bekannt sind oder von einer zuständigen Behörde offengelegt werden müssen.",
      "<strong>Laufzeit:</strong> der Zeitraum, in dem die Geheimhaltungspflicht gilt, typischerweise 1, 3 oder 5 Jahre, je nach Fall auch unbefristet.",
      "<strong>Sanktionen bei Vertragsverletzung:</strong> die wirtschaftlichen oder rechtlichen Folgen (Schadenersatz, Vertragsstrafen, einstweilige Verfügungen), falls eine Partei Informationen unbefugt offenlegt.",
      "<strong>Anwendbares Recht und Gerichtsstand:</strong> das Land oder die Stadt, deren Gerichte und Gesetze über etwaige Streitigkeiten aus der Vereinbarung entscheiden."
    ],
    guide_h3_3: "B2B-Dienstleistungsverträge",
    guide_p_3: "Ein B2B-Vertrag (Business-to-Business) formalisiert die Beziehung zwischen zwei Unternehmen, wobei eines dem anderen Dienstleistungen erbringt. Neben der Festlegung von Leistungsumfang und Fristen enthält er in der Regel Geheimhaltungsklauseln zum Schutz der im Rahmen der Zusammenarbeit ausgetauschten Informationen sowie Regelungen zum anwendbaren Gerichtsstand im Streitfall.",
    guide_h3_4: "Hinweise zur Unterzeichnung und Sicherstellung der Rechtsgültigkeit",
    guide_p_tips_intro: "Damit Ihre NDA oder Ihr B2B-Vertrag möglichst rechtssicher ist, beachten Sie vor der Unterzeichnung folgende Empfehlungen:",
    guide_list_tips: [
      "Überprüfen Sie die Identität und Vertretungsbefugnis der Personen, die im Namen jedes Unternehmens unterzeichnen.",
      "Unterzeichnen Sie das Dokument in doppelter Ausfertigung (eine Kopie je Partei) oder nutzen Sie eine in Ihrem Land rechtlich anerkannte E-Signatur-Plattform.",
      "Geben Sie stets das Unterzeichnungsdatum an — es ist für die Berechnung von Fristen und die zeitliche Anwendbarkeit des Rechts wesentlich.",
      "Passen Sie Gerichtsstands- und Vertragsstrafenklauseln an das örtliche Recht an, bevor Sie sich im Streitfall auf das Dokument berufen.",
      "Bewahren Sie eine unterzeichnete Kopie und nach Möglichkeit einen Zustell- oder Empfangsnachweis auf (Einschreiben, zeitgestempelte E-Signatur).",
      "Lassen Sie das Dokument bei besonders sensiblen Informationen oder Verträgen mit hohem Wert vor der Unterzeichnung von einem qualifizierten Rechtsanwalt prüfen."
    ],
    faq_title: "Häufig gestellte Fragen",
    faq_q1: "Ist eine online erstellte NDA rechtsverbindlich?",
    faq_a1: "Ja, das kann sie sein. Eine mit diesem Tool erstellte NDA hat dieselbe Gültigkeit wie jeder andere Vertrag, sofern sie die wesentlichen Elemente enthält (klar identifizierte Parteien, ein rechtmäßiger Zweck und Zustimmung) und von beiden Parteien ordnungsgemäß unterzeichnet wird. Die konkrete Durchsetzbarkeit hängt jedoch vom Recht Ihres Landes ab, weshalb wir empfehlen, sie vor der Unterzeichnung von einem Rechtsanwalt prüfen zu lassen, insbesondere bei hochwertigen Vereinbarungen.",
    faq_q2: "Was ist der Unterschied zwischen einer einseitigen und einer gegenseitigen NDA?",
    faq_a2: "Bei einer einseitigen NDA gibt nur eine Partei (die offenlegende) vertrauliche Informationen preis, und die andere (die empfangende) verpflichtet sich, diese zu schützen. Bei einer gegenseitigen oder zweiseitigen NDA tauschen beide Parteien vertrauliche Informationen miteinander aus, sodass beide gleichzeitig als offenlegende und empfangende Partei auftreten.",
    faq_q3: "Wie lange sollte die Geheimhaltung dauern?",
    faq_a3: "Es gibt keine feste Regel: Am gängigsten sind 1, 3 oder 5 Jahre ab Unterzeichnung. In besonders sensiblen Bereichen, etwa bei gewerblichen Betriebsgeheimnissen oder Quellcode, wird häufig eine unbefristete Laufzeit vereinbart, die so lange gilt, wie die Informationen ihren vertraulichen Charakter behalten.",
    faq_q4: "Brauche ich einen Anwalt, um sie zu unterzeichnen?",
    faq_a4: "Es ist nicht zwingend erforderlich, wird aber dringend empfohlen, insbesondere wenn die Vereinbarung hochwertige Informationen schützt, eine lange Laufzeit hat oder Teil einer komplexen Verhandlung ist. Mit diesem Tool können Sie einen vollständigen, professionellen Entwurf erstellen, den Sie anschließend von einem Anwalt vor der endgültigen Unterzeichnung prüfen lassen können.",
    faq_q5: "Was passiert, wenn jemand gegen die Vereinbarung verstößt?",
    faq_a5: "Ein Verstoß gegen eine NDA kann zu einem Schadenersatzanspruch, einer einstweiligen Verfügung zur Beendigung oder Verhinderung einer laufenden Offenlegung sowie zur Anwendung etwaiger in der entsprechenden Klausel vereinbarter Vertragsstrafen führen. Zur Durchsetzung muss die betroffene Partei den Verstoß und den erlittenen Schaden vor dem in der Gerichtsstandsklausel genannten zuständigen Gericht nachweisen können.",
    faq_q6: "Wie unterzeichne ich dieses Dokument?",
    faq_a6: "Sie können das vom Tool erstellte PDF herunterladen und ausdrucken, damit beide Parteien es handschriftlich unterzeichnen, idealerweise in doppelter Ausfertigung. Sie können auch eine in Ihrem Land rechtlich anerkannte E-Signatur-Plattform verwenden. In jedem Fall sollten Sie sicherstellen, dass das Unterzeichnungsdatum klar vermerkt ist, und eine Kopie des unterzeichneten Dokuments aufbewahren.",
    disclaimer_title: "Rechtlicher Hinweis:",
    disclaimer_text: "Die mit diesem Tool erstellten Dokumente sind Musterentwürfe auf Grundlage von Standardklauseln, die üblicherweise in Geheimhaltungsvereinbarungen und B2B-Dienstleistungsverträgen verwendet werden. Sie dienen ausschließlich zu Informations- und Referenzzwecken und stellen keine Rechts-, Steuer- oder sonstige professionelle Beratung dar und begründen kein Mandatsverhältnis zwischen dem Nutzer und den Betreibern dieses Tools. Die für Geheimhaltungsvereinbarungen und Handelsverträge geltenden Gesetze variieren erheblich je nach Land, Bundesland oder Rechtsordnung, sodass diese Vorlagen vor Gebrauch möglicherweise an die örtlichen Vorschriften angepasst werden müssen. Der Nutzer ist allein dafür verantwortlich, den erstellten Inhalt zu prüfen, zu vervollständigen und anzupassen sowie dessen Gültigkeit und Eignung für den jeweiligen Einzelfall zu überprüfen. Wir empfehlen dringend, jedes mit diesem Tool erstellte Dokument vor der Unterzeichnung oder Verwendung von einem entsprechend qualifizierten Rechtsanwalt prüfen zu lassen. Die Betreiber dieses Tools haften unter keinen Umständen für Schäden, Verluste oder Folgen, die sich aus der Nutzung, dem Missbrauch oder der Auslegung der erstellten Dokumente ergeben.",
    benefits_title: "Warum DraftB2B nutzen?",
    benefits_subtitle: "Der schnellste, sicherste und professionellste Weg, Ihre vertraulichen Informationen zu schützen.",
    benefit_1_title: "100% kostenlos & keine Registrierung",
    benefit_1_desc: "Erstellen und laden Sie Ihre Dokumente kostenlos herunter, ohne ein Konto zu erstellen oder Ihre E-Mail-Adresse anzugeben.",
    benefit_2_title: "Vollständige Privatsphäre (Client-seitig)",
    benefit_2_desc: "Die gesamte Verarbeitung erfolgt direkt in Ihrem Browser. Ihre Daten werden niemals an einen Server gesendet oder dort gespeichert.",
    benefit_3_title: "B2B-Standard & rechtliche Gültigkeit",
    benefit_3_desc: "Klauseln, die nach international gebräuchlichen Rechtsstandards für Geheimhaltungs- und B2B-Vereinbarungen formuliert sind.",
    benefit_4_title: "Zweisprachiger Modus & doppelter Export",
    benefit_4_desc: "Erstellen Sie Verträge in zwei Sprachen nebeneinander und exportieren Sie sie mit einem Klick als PDF oder Word-Datei.",
    donate_btn_label: "Dieses Projekt unterstützen",
    donate_modal_title: "Dieses Projekt unterstützen",
    donate_modal_desc: "DraftB2B ist kostenlos und erfordert keine Registrierung. Wenn Ihnen dieses Tool nützlich war, spendieren Sie uns doch einen Kaffee, um den Betrieb zu unterstützen.",
    donate_custom_placeholder: "Anderer Betrag",
    donate_thanks_msg: "Vielen Dank für Ihre Unterstützung! Sie werden zur Zahlungsplattform weitergeleitet.",
    donate_btn_confirm: "Weiter",
    footer_rights: "Alle Rechte vorbehalten.",
    footer_note: "Kostenloses Tool · Ersetzt keine professionelle Rechtsberatung.",
    footer_feedback_link: "Problem melden / Vorlage vorschlagen",
    ...
    terms_modal_content: `<p>Zuletzt aktualisiert: 22. August 2026.</p>
      ...
      <h3>2. Keine Rechtsberatung</h3>
      <p>Die Nutzung von DraftB2B <strong>stellt keine Rechtsberatung dar</strong> und begründet kein Mandatsverhältnis zwischen Ihnen und DraftB2B oder anderen mit dem Projekt verbundenen Personen. Die Vorlagen bieten einen allgemeinen Ausgangspunkt und ersetzen nicht die Prüfung durch einen zugelassenen Rechtsanwalt in Ihrer Rechtsordnung, der den Inhalt an Ihren konkreten Fall, das anwendbare lokale Recht und die Besonderheiten Ihres Unternehmens anpassen kann.</p>
      <h3>3. Verantwortung des Nutzers</h3>
      <p>Sie sind dafür verantwortlich, jedes mit diesem Tool erstellte Dokument zu prüfen, anzupassen und zu validieren, bevor Sie es unterzeichnen, versenden oder rechtsverbindlich verwenden. Wir empfehlen dringend, das endgültige Dokument von einem Rechtsanwalt prüfen zu lassen.</p>
      <h3>4. Gewährleistungsausschluss</h3>
      <p>DraftB2B wird „wie besehen\" und „wie verfügbar\" ohne jegliche ausdrückliche oder stillschweigende Gewährleistung bereitgestellt, einschließlich, aber nicht beschränkt auf Gewährleistungen der Eignung für einen bestimmten Zweck, der Richtigkeit, der regulatorischen Aktualität oder der Durchsetzbarkeit in einer bestimmten Rechtsordnung.</p>
      <h3>5. Haftungsbeschränkung</h3>
      <p>Soweit gesetzlich zulässig, haften DraftB2B und die für seine Entwicklung verantwortlichen Personen nicht für unmittelbare, mittelbare, beiläufige oder Folgeschäden, die sich aus der Nutzung oder der Unmöglichkeit der Nutzung von mit diesem Tool erstellten Dokumenten ergeben.</p>
      <h3>6. Eigentum an erstellten Dokumenten</h3>
      <p>Die konkreten Inhalte, die Sie in das Formular eingeben, sowie das von Ihnen heruntergeladene endgültige Dokument gehören Ihnen. Der Code, das Design, die Basisvorlagen und der Betrieb der DraftB2B-Plattform sind Eigentum der Entwickler.</p>
      <h3>7. Zulässige Nutzung</h3>
      <p>Sie verpflichten sich, dieses Tool nicht zur Erstellung von Dokumenten für rechtswidrige oder betrügerische Zwecke oder zur Verletzung der Rechte Dritter zu verwenden.</p>
      <h3>8. Änderungen dieser Bedingungen</h3>
      <p>Wir können diese Bedingungen gelegentlich aktualisieren, um Änderungen am Tool widerzuspiegeln. Das Datum der letzten Aktualisierung wird oben in diesem Dokument angezeigt.</p>`,
    privacy_modal_content: `<p>Zuletzt aktualisiert: 22. August 2026.</p>
      <h3>1. 100% clientseitige Architektur</h3>
      <p>DraftB2B verfügt über keinen eigenen Backend-Server. Die gesamte Verarbeitung — die Erstellung des Dokuments, die Berechnung des SHA-256-Integritätssiegels, die Erzeugung des QR-Codes sowie die Erstellung der PDF- und Word-Datei — erfolgt vollständig in Ihrem eigenen Browser, auf Ihrem eigenen Gerät. Keine der von Ihnen in das Formular eingegebenen Daten (Namen, Adressen, Steuernummern, Klauseln, digitalisierte handschriftliche Unterschriften, Logos) wird an einen Server von uns gesendet, dort verarbeitet oder gespeichert, da ein solcher Server nicht existiert.</p>
      <h3>2. Verwendung des lokalen Speichers (localStorage)</h3>
      <p>Zu Ihrer Bequemlichkeit speichert DraftB2B bestimmte Informationen ausschließlich im lokalen Speicher Ihres eigenen Browsers (localStorage/sessionStorage); diese verlassen Ihr Gerät niemals:</p>
      <ul>
        <li>Eine automatische Speicherung Ihres laufenden Formulars, damit Ihre Arbeit beim Schließen des Tabs nicht verloren geht.</li>
        <li>Einen Verlauf der zuletzt auf diesem Gerät erstellten Dokumente.</li>
        <li>Eine von Ihnen manuell gespeicherte Vorlage, sofern Sie diese Funktion nutzen.</li>
        <li>Ihre Sprach- und Hell-/Dunkelmodus-Einstellungen.</li>
        <li>Ein Kennzeichen, ob Sie den Hinweis auf neue Vorlagen bereits bestätigt oder geschlossen haben, damit er nicht erneut angezeigt wird.</li>
      </ul>
      <p>Sie können all dies jederzeit löschen, indem Sie die Browserdaten dieser Website in den Einstellungen Ihres eigenen Browsers entfernen.</p>
      <h3>3. Teilbare Links</h3>
      <p>Wenn Sie die Funktion zum Teilen eines vorausgefüllten Entwurfs nutzen, werden die Formulardaten direkt in der URL des Links selbst kodiert — nicht in einer externen Datenbank. Jeder, der diesen Link erhält, kann diese Informationen einsehen; teilen Sie ihn daher nur mit der vorgesehenen Gegenpartei.</p>
      <h3>4. Von uns genutzte Dienste Dritter</h3>
    ...
    btn_docx: "Word herunterladen (.docx)",
    docx_generating: "Word-Datei wird erstellt...",
    docx_error: "Die Word-Datei konnte nicht erstellt werden. Bitte versuchen Sie es erneut.",
    docx_lib_error: "Die Word-Exportfunktion konnte nicht geladen werden. Überprüfen Sie Ihre Internetverbindung.",

    /* --- Logo --- */
    logo_upload_btn: "Firmenlogo hochladen (optional)",
    logo_remove_btn: "Logo entfernen",
    logo_error_type: "Nicht unterstütztes Bildformat. Verwenden Sie PNG, JPG oder SVG.",

    /* --- Digital signature --- */
    sig_modal_title: "Digitale Unterschrift",
    sig_tab_draw: "Zeichnen",
    sig_tab_upload: "Bild hochladen",
    sig_draw_hint: "Zeichnen Sie Ihre Unterschrift oben mit der Maus oder dem Finger.",
    sig_slots_optional_hint: "Optional: Sie können die Unterschrift leer lassen, um das Dokument auszudrucken und handschriftlich zu unterzeichnen.",
    sig_upload_btn: "Bild auswählen (PNG/JPG)",
    sig_upload_hint: "Das Bild wird automatisch an das Unterschriftsfeld angepasst.",
    sig_btn_clear: "Unterschrift löschen",
    sig_btn_confirm: "Unterschrift bestätigen",
    btn_cancel: "Abbrechen",
    sig_add_btn: "Unterschrift hinzufügen",
    sig_edit_btn: "Bearbeiten",
    sig_remove_btn: "Entfernen",
    sig_slot_prefix: "Unterschrift:",
    sig_error_empty: "Zeichnen oder laden Sie ein Bild hoch, bevor Sie die Unterschrift bestätigen.",

    /* --- Persistence --- */
    btn_save_template: "Meine Angaben als Vorlage speichern",
    btn_load_template: "Meine Angaben laden",
    autosave_note: "Ihre Daten werden automatisch in diesem Browser gespeichert.",
    template_saved: "Angaben der offenlegenden Partei als Vorlage gespeichert.",
    template_loaded: "Vorlage erfolgreich geladen.",
    template_empty: "Sie haben noch keine Vorlage gespeichert.",

    /* --- Completion & validation --- */
    completion_label: "Fortschritt des Dokuments",
    validation_missing: "Füllen Sie die markierten Pflichtfelder aus, bevor Sie das Dokument herunterladen.",
    validation_alert_title: "Unvollständige Pflichtfelder",
    validation_alert_intro: "Bitte vervollständigen Sie:",
    validation_field_name: "Name / Unternehmen",
    validation_field_id: "Steuernummer",
    validation_field_address: "Geschäftsadresse",
    validation_field_purpose: "Zweck",
    validation_field_jurisdiction: "Gerichtsstand",
    validation_field_signature: "Unterschrift",

    /* --- Bilingual mode & custom filename --- */
    bilingual_mode_label: "Zweisprachiger Modus (Zwei Sprachen)",
    bilingual_primary_label: "Hauptsprache",
    bilingual_secondary_label: "Zweite Sprache",
    custom_filename_label: "Benutzerdefinierter Dateiname (optional)",
    custom_filename_placeholder: "Z. B. NDA_MusterGmbH_2026",

    doc_title_nda_unilateral: "EINSEITIGE GEHEIMHALTUNGSVEREINBARUNG",
    doc_title_nda_mutual: "GEGENSEITIGE (ZWEISEITIGE) GEHEIMHALTUNGSVEREINBARUNG",
    doc_title_b2b_services: "B2B-DIENSTLEISTUNGSVERTRAG",
    doc_subtitle: "Dokument erstellt am {date}",
    ph_nameA: "[Name der offenlegenden Partei]",
    ph_nameB: "[Name der empfangenden Partei]",
    ph_id: "[Steuernummer nicht angegeben]",
    ph_addr: "[Adresse nicht angegeben]",
    ph_purpose: "[Zweck nicht angegeben]",
    ph_jur: "[Gerichtsstand nicht angegeben]",
    role_discloser: "DIE OFFENLEGENDE PARTEI",
    role_receiver: "DIE EMPFANGENDE PARTEI",
    role_first: "DIE ERSTE PARTEI",
    role_second: "DIE ZWEITE PARTEI",
    role_provider: "DER DIENSTLEISTER",
    role_client: "DER KUNDE",
    intro_nda: "Diese Geheimhaltungsvereinbarung (die „Vereinbarung\") wird geschlossen zwischen {nameA}, ausgewiesen mit {idA} und ansässig in {addrA} (nachfolgend „{roleA}\"); und {nameB}, ausgewiesen mit {idB} und ansässig in {addrB} (nachfolgend „{roleB}\"), gemeinsam die „Parteien\", zu folgenden Bedingungen:",
    intro_b2b: "Dieser Dienstleistungsvertrag (der „Vertrag\") wird geschlossen zwischen {nameA}, ausgewiesen mit {idA} und ansässig in {addrA} (nachfolgend „{roleA}\"); und {nameB}, ausgewiesen mit {idB} und ansässig in {addrB} (nachfolgend „{roleB}\"), gemeinsam die „Parteien\", zu folgenden Bedingungen:",

    c1_title_nda: "ERSTENS. GEGENSTAND",
    c1_body_nda_uni: "Diese Vereinbarung legt die Bedingungen fest, unter denen {roleA} {roleB} bestimmte vertrauliche Informationen im Zusammenhang mit Folgendem offenlegt: {purpose}. {roleB} verpflichtet sich, diese Informationen ausschließlich zu diesem Zweck zu verwenden.",
    c1_body_nda_mutual: "Diese Vereinbarung legt die Bedingungen fest, unter denen {roleA} und {roleB} einander vertrauliche Informationen im Zusammenhang mit Folgendem offenlegen können: {purpose}. Jede Partei verpflichtet sich, die erhaltenen Informationen ausschließlich zu diesem Zweck zu verwenden.",
    c1_title_b2b: "ERSTENS. VERTRAGSGEGENSTAND",
    c1_body_b2b: "{roleA} verpflichtet sich, {roleB} folgende Dienstleistungen zu erbringen: {purpose}. Die Dienstleistungen werden nach den geltenden fachlichen Standards und mit der gebotenen Sorgfalt erbracht.",

    c2_title_nda_uni: "ZWEITENS. PFLICHTEN DER EMPFANGENDEN PARTEI",
    c2_body_nda_uni: "{roleB} verpflichtet sich: (i) die vertraulichen Informationen streng vertraulich zu behandeln; (ii) sie ohne vorherige schriftliche Zustimmung von {roleA} nicht an Dritte weiterzugeben; (iii) sie nicht für andere als die in der Ersten Klausel genannten Zwecke zu verwenden; und (iv) angemessene Sicherheitsmaßnahmen zu treffen, um eine versehentliche oder unbefugte Offenlegung zu verhindern.",
    c2_title_nda_mutual: "ZWEITENS. DEFINITION UND GEHEIMHALTUNGSPFLICHTEN",
    c2_body_nda_mutual: "Für die Zwecke dieser Vereinbarung bezeichnet „Vertrauliche Informationen\" jegliche technischen, kaufmännischen, finanziellen, betrieblichen oder sonstigen Informationen, die eine Partei der anderen offenlegt, sei es in schriftlicher, mündlicher, visueller oder elektronischer Form, die als vertraulich gekennzeichnet sind oder die aufgrund ihrer Natur oder der Umstände ihrer Offenlegung vernünftigerweise als vertraulich zu verstehen sind. Jede Partei verpflichtet sich, sofern sie als empfangende Partei handelt: (i) die erhaltenen vertraulichen Informationen streng vertraulich zu behandeln; (ii) sie ohne vorherige schriftliche Zustimmung der offenlegenden Partei nicht an Dritte weiterzugeben; (iii) sie nicht für andere als die in der Ersten Klausel genannten Zwecke zu verwenden; und (iv) angemessene Sicherheitsmaßnahmen zu treffen, um eine versehentliche oder unbefugte Offenlegung zu verhindern.",
    c2_title_b2b: "ZWEITENS. VERTRAULICHKEIT",
    c2_body_b2b: "Die Parteien verpflichten sich, alle im Zusammenhang mit der Erfüllung dieser Vereinbarung ausgetauschten technischen, kaufmännischen oder finanziellen Informationen streng vertraulich zu behandeln und nicht ohne vorherige schriftliche Zustimmung der anderen Partei an Dritte weiterzugeben, es sei denn, dies ist gesetzlich oder von einer zuständigen Behörde vorgeschrieben.",

    c3_title: "DRITTENS. AUSNAHMEN",
    c3_body: "Die Geheimhaltungspflichten gelten nicht für Informationen, die: (a) ohne Verschulden der empfangenden Partei öffentlich zugänglich sind oder werden; (b) der empfangenden Partei vor der Offenlegung rechtmäßig bekannt waren; (c) rechtmäßig und ohne Geheimhaltungsbeschränkung von einem Dritten erhalten wurden; (d) aufgrund einer gesetzlichen, gerichtlichen oder behördlichen Verpflichtung offengelegt werden müssen, vorbehaltlich einer vorherigen Mitteilung an die andere Partei, soweit möglich; oder (e) von der empfangenden Partei unabhängig entwickelt wurden, ohne die vertraulichen Informationen der offenlegenden Partei zu verwenden oder darauf Bezug zu nehmen.",

    c4_title_nda: "VIERTENS. LAUFZEIT UND DAUER",
    c4_body_nda: "Die in dieser Vereinbarung festgelegten Geheimhaltungspflichten bleiben für {duration} ab dem Datum der Unterzeichnung in Kraft, unabhängig von der Beendigung einer etwaigen Geschäftsbeziehung zwischen den Parteien.",
    c_ip_title_b2b: "DRITTENS. GEISTIGES EIGENTUM UND EIGENTUM AN LEISTUNGSERGEBNISSEN",
    c_ip_body_b2b: "Nach vollständiger Zahlung der entsprechenden Vergütung überträgt {roleA} {roleB} das Eigentum an den speziell in Auftrag gegebenen und im Rahmen dieses Vertrags entwickelten Leistungsergebnissen. {roleA} behält das ausschließliche Eigentum an seinen bereits bestehenden oder allgemein verwendbaren Werkzeugen, Methoden, Vorlagen, Know-how und sonstigem geistigen Eigentum, auch wenn diese bei der Erbringung der Dienstleistungen verwendet werden, und darf sie weiterhin frei in anderen Projekten nutzen.",
    c4_title_b2b: "VIERTENS. LAUFZEIT UND VERTRAULICHKEIT",
    c4_body_b2b: "Dieser Vertrag bleibt für {duration} ab dem Datum seiner Unterzeichnung in Kraft. Die in der Zweiten Klausel festgelegten Geheimhaltungspflichten gelten für diesen Zeitraum und nach Beendigung des Vertrags aus jeglichem Grund fort.",

    c5_title: "FÜNFTENS. RÜCKGABE ODER VERNICHTUNG VON INFORMATIONEN",
    c5_body: "Auf Verlangen der offenlegenden Partei oder bei Beendigung dieser Vereinbarung hat die empfangende Partei alle Dokumente, Datenträger und Kopien, die vertrauliche Informationen enthalten, wie angewiesen zurückzugeben oder zu vernichten und die Rückgabe oder Vernichtung schriftlich zu bestätigen.",

    c6_title_nda: "SECHSTENS. KEINE LIZENZ- ODER ARBEITSVERHÄLTNISSE",
    c6_body_nda: "Keine Bestimmung dieser Vereinbarung ist so auszulegen, dass sie eine Lizenz oder ein Recht des geistigen oder gewerblichen Eigentums einräumt oder ein Arbeits-, Gesellschafts- oder Vertretungsverhältnis zwischen den Parteien begründet.",
    c6_title_b2b: "FÜNFTENS. ART DER BEZIEHUNG",
    c6_body_b2b: "Diese Vereinbarung begründet kein Arbeits-, Gesellschafts-, Vertretungs- oder Handelsvertreterverhältnis zwischen den Parteien. {roleA} handelt als selbständiger Auftragnehmer und behält bei der Erbringung der Dienstleistungen die volle fachliche und organisatorische Eigenständigkeit.",

    c7_title: "SIEBTENS. ANWENDBARES RECHT UND GERICHTSSTAND",
    c7_title_b2b: "SECHSTENS. ANWENDBARES RECHT UND GERICHTSSTAND",
    c7_body: "Dieses Dokument unterliegt dem geltenden Recht in {jurisdiction} und ist danach auszulegen. Jede Streitigkeit, die sich aus seiner Auslegung oder Erfüllung ergibt, wird den zuständigen Gerichten dieser Rechtsordnung vorgelegt, wobei die Parteien ausdrücklich auf jeden anderen sonst anwendbaren Gerichtsstand verzichten. Mangels ausdrücklicher Wahl des Gerichtsstands gilt das Recht am Wohnsitz/Sitz von {roleA}.",

    c8_title: "ACHTENS. ALLGEMEINE BESTIMMUNGEN",
    c8_title_b2b: "SIEBTENS. ALLGEMEINE BESTIMMUNGEN",
    c8_body: "Dieses Dokument stellt die gesamte Vereinbarung zwischen den Parteien in Bezug auf seinen Gegenstand dar und ersetzt alle vorherigen mündlichen oder schriftlichen Absprachen. Jede Änderung bedarf der Schriftform und der Unterschrift beider Parteien. Sollte eine Klausel für nichtig oder undurchsetzbar erklärt werden, bleibt die Wirksamkeit der übrigen Bestimmungen unberührt.",
    c_force_majeure_title: "NEUNTENS. HÖHERE GEWALT",
    c_force_majeure_title_b2b: "ACHTENS. HÖHERE GEWALT",
    c_force_majeure_body: "Keine der Parteien haftet für eine Nichterfüllung oder Verzögerung bei der Erfüllung ihrer Pflichten aus diesem Dokument, wenn diese Nichterfüllung oder Verzögerung auf Umständen beruht, die vernünftigerweise außerhalb ihrer Kontrolle liegen, einschließlich, aber nicht beschränkt auf Naturkatastrophen, behördliche Maßnahmen, bewaffnete Konflikte, Pandemien, weitreichende Ausfälle der Telekommunikations- oder Energieinfrastruktur oder andere Fälle höherer Gewalt. Die betroffene Partei benachrichtigt die andere Partei so bald wie vernünftigerweise möglich und unternimmt angemessene Anstrengungen, um die Auswirkungen eines solchen Ereignisses zu mindern.",
    c_remedies_title: "ZEHNTENS. RECHTSBEHELFE UND EINSTWEILIGE VERFÜGUNG",
    c_remedies_body: "Die Parteien erkennen an, dass eine Verletzung der in dieser Vereinbarung festgelegten Geheimhaltungspflichten der offenlegenden Partei einen nicht wiedergutzumachenden Schaden zufügen kann, für den ein Geldersatz allein möglicherweise keinen angemessenen Rechtsbehelf darstellt. Dementsprechend ist die offenlegende Partei berechtigt, bei der zuständigen Behörde eine einstweilige Verfügung oder die Erfüllung in Natur zu beantragen, unbeschadet anderer ihr nach geltendem Recht zustehender Rechtsbehelfe.",

    sign_place_date: "In {jurisdiction}, zum unten angegebenen Unterzeichnungsdatum.",
    sign_label: "Unterschrift",
    sign_name_label: "Name und Funktion",

    duration_1: "ein (1) Jahr",
    duration_3: "drei (3) Jahre",
    duration_5: "fünf (5) Jahre",
    duration_indefinite: "einen unbefristeten Zeitraum, solange die Informationen ihren vertraulichen Charakter behalten",

    /* --- Letterhead / signature cards / footer (editorial redesign) --- */
    doc_ref_label: "REF",
    doc_issue_date_label: "Ausstellungsdatum",
    doc_parties_heading: "Parteien",
    sign_field_name: "Vollständiger Name",
    sign_field_role: "Titel / Funktion",
    sign_field_id: "Ausweisdokument",
    sign_field_date: "Datum",
    sign_field_authorized: "Bevollmächtigte Unterschrift",
    doc_verified_badge: "Elektronisch erstelltes und verifiziertes Dokument",
    pdf_footer_confidential: "Vertrauliches Dokument · Nur zur Verwendung durch die unterzeichnenden Parteien",
    pdf_footer_page_of: "Seite {current} von {total}",
  },
  ...
  pt: {
    ...
    terms_modal_content: `<p>Última atualização: 22 de agosto de 2026.</p>
      ...
      <h3>2. Não é consultoria jurídica</h3>
      <p>O uso do DraftB2B <strong>não constitui consultoria jurídica</strong> nem cria uma relação advogado-cliente entre você e o DraftB2B ou qualquer pessoa vinculada ao projeto. Os modelos oferecem um ponto de partida geral e não substituem a revisão de um advogado licenciado em sua jurisdição, que poderá adaptar o conteúdo ao seu caso específico, à legislação local vigente e às particularidades da sua operação.</p>
      <h3>3. Responsabilidade do usuário</h3>
      <p>Você é responsável por revisar, adaptar e validar qualquer documento gerado com esta ferramenta antes de assiná-lo, enviá-lo ou dar-lhe qualquer uso com efeitos legais. Recomendamos fortemente que um profissional do direito revise o documento final.</p>
      <h3>4. Isenção de garantias</h3>
      <p>O DraftB2B é oferecido "no estado em que se encontra" e "conforme disponibilidade", sem garantias de qualquer tipo, expressas ou implícitas, incluindo (sem limitação) garantias de adequação a um propósito específico, exatidão, atualização normativa ou aplicabilidade em uma jurisdição específica.</p>
      <h3>5. Limitação de responsabilidade</h3>
      <p>Na máxima medida permitida pela lei aplicável, o DraftB2B e as pessoas responsáveis por seu desenvolvimento não serão responsáveis por danos diretos, indiretos, incidentais ou consequenciais decorrentes do uso ou da impossibilidade de uso dos documentos gerados com esta ferramenta.</p>
      <h3>6. Propriedade dos documentos gerados</h3>
      <p>O conteúdo específico que você insere no formulário e o documento final que você baixa pertencem a você. O código, design, modelos base e funcionamento da plataforma DraftB2B são propriedade de seus desenvolvedores.</p>
      <h3>7. Uso aceitável</h3>
      <p>Você se compromete a não utilizar esta ferramenta para gerar documentos com fins ilícitos, fraudulentos ou que infrinjam direitos de terceiros.</p>
      <h3>8. Alterações a estes termos</h3>
      <p>Podemos atualizar estes termos ocasionalmente para refletir mudanças na ferramenta. A data da última atualização é indicada no início deste documento.</p>`,
    privacy_modal_content: `<p>Última atualização: 22 de agosto de 2026.</p>
      <h3>1. Arquitetura 100% do lado do cliente</h3>
      <p>O DraftB2B não possui servidor de backend próprio. Todo o processamento —a redação do documento, o cálculo do selo de integridade SHA-256, a geração do código QR, a criação do PDF e do arquivo Word— ocorre inteiramente dentro do seu próprio navegador, no seu próprio dispositivo. Nenhum dado que você insira no formulário (nomes, endereços, identificações fiscais, cláusulas, assinaturas manuscritas digitalizadas, logotipos) é enviado, processado ou armazenado em qualquer servidor nosso, porque esse servidor não existe.</p>
      <h3>2. Uso de armazenamento local (localStorage)</h3>
      <p>Para sua conveniência, o DraftB2B armazena certas informações apenas no armazenamento local do seu próprio navegador (localStorage/sessionStorage), sem que saiam do seu dispositivo:</p>
      <ul>
        <li>O salvamento automático do formulário em andamento, para que você não perca seu trabalho se fechar a aba.</li>
        <li>O histórico dos documentos mais recentes gerados neste dispositivo.</li>
        <li>Um modelo salvo manualmente por você, se utilizar esse recurso.</li>
        <li>Suas preferências de idioma e de tema claro/escuro.</li>
        <li>Um indicador de se você já preencheu ou dispensou o aviso de novos modelos, para não mostrá-lo novamente.</li>
      </ul>
      <p>Você pode apagar todas essas informações a qualquer momento excluindo os dados de navegação deste site nas configurações do seu próprio navegador.</p>
      <h3>3. Links para compartilhar</h3>
      <p>Se você usar o recurso de compartilhar um rascunho pré-preenchido, os dados do formulário são codificados diretamente dentro da própria URL do link —não em um banco de dados externo. Qualquer pessoa que receba esse link poderá ver essas informações, então compartilhe-o apenas com a contraparte correspondente.</p>
      <h3>4. Serviços de terceiros que utilizamos</h3>
  ...
  fr: {
    ...
    terms_modal_content: `<p>Dernière mise à jour : 22 août 2026.</p>
      ...
      <h3>2. Ce n'est pas un conseil juridique</h3>
      <p>L'utilisation de DraftB2B <strong>ne constitue pas un conseil juridique</strong> et ne crée pas de relation avocat-client entre vous et DraftB2B ou toute personne associée au projet. Les modèles offrent un point de départ général et ne remplacent pas l'examen par un avocat inscrit au barreau de votre juridiction, qui pourra adapter le contenu à votre cas précis, à la législation locale en vigueur et aux particularités de votre activité.</p>
      <h3>3. Responsabilité de l'utilisateur</h3>
      <p>Vous êtes responsable de la relecture, de l'adaptation et de la validation de tout document généré avec cet outil avant de le signer, de l'envoyer ou de lui donner un usage ayant des effets juridiques. Nous vous recommandons vivement de faire relire le document final par un professionnel du droit.</p>
      <h3>4. Exclusion de garanties</h3>
      <p>DraftB2B est fourni « en l'état » et « selon disponibilité », sans garantie d'aucune sorte, expresse ou implicite, y compris (sans s'y limiter) les garanties d'adéquation à un usage particulier, d'exactitude, d'actualité réglementaire ou d'applicabilité dans une juridiction spécifique.</p>
      <h3>5. Limitation de responsabilité</h3>
      <p>Dans toute la mesure permise par la loi applicable, DraftB2B et les personnes responsables de son développement ne pourront être tenus responsables des dommages directs, indirects, accessoires ou consécutifs découlant de l'utilisation ou de l'impossibilité d'utiliser les documents générés avec cet outil.</p>
      <h3>6. Propriété des documents générés</h3>
      <p>Le contenu spécifique que vous saisissez dans le formulaire et le document final que vous téléchargez vous appartiennent. Le code, la conception, les modèles de base et le fonctionnement de la plateforme DraftB2B sont la propriété de ses développeurs.</p>
      <h3>7. Utilisation acceptable</h3>
      <p>Vous vous engagez à ne pas utiliser cet outil pour générer des documents à des fins illicites, frauduleuses ou portant atteinte aux droits de tiers.</p>
      <h3>8. Modifications de ces conditions</h3>
      <p>Nous pouvons mettre à jour ces conditions occasionnellement pour refléter les évolutions de l'outil. La date de dernière mise à jour est indiquée en haut de ce document.</p>`,
    privacy_modal_content: `<p>Dernière mise à jour : 22 août 2026.</p>
      <h3>1. Architecture 100 % côté client</h3>
      <p>DraftB2B ne dispose d'aucun serveur back-end propre. Tout le traitement —la rédaction du document, le calcul du sceau d'intégrité SHA-256, la génération du code QR, la création du PDF et du fichier Word— se déroule entièrement dans votre propre navigateur, sur votre propre appareil. Aucune donnée que vous saisissez dans le formulaire (noms, adresses, numéros d'identification fiscale, clauses, signatures manuscrites numérisées, logos) n'est envoyée, traitée ni stockée sur un quelconque serveur de notre part, car ce serveur n'existe pas.</p>
      <h3>2. Utilisation du stockage local (localStorage)</h3>
      <p>Pour votre confort, DraftB2B stocke certaines informations uniquement dans le stockage local de votre propre navigateur (localStorage/sessionStorage), sans qu'elles ne quittent jamais votre appareil :</p>
      <ul>
        <li>La sauvegarde automatique du formulaire en cours, pour que vous ne perdiez pas votre travail si vous fermez l'onglet.</li>
        <li>L'historique des documents les plus récemment générés sur cet appareil.</li>
        <li>Un modèle que vous avez enregistré manuellement, si vous utilisez cette fonction.</li>
        <li>Vos préférences de langue et de thème clair/sombre.</li>
        <li>Un indicateur permettant de savoir si vous avez déjà complété ou fermé l'invite d'information sur les nouveaux modèles, afin de ne pas vous la montrer à nouveau.</li>
      </ul>
      <p>Vous pouvez effacer toutes ces informations à tout moment en supprimant les données de navigation de ce site depuis les paramètres de votre propre navigateur.</p>
      <h3>3. Liens de partage</h3>
      <p>Si vous utilisez la fonction de partage d'un brouillon pré-rempli, les données du formulaire sont encodées directement dans l'URL du lien lui-même —et non dans une base de données externe. Toute personne recevant ce lien pourra voir ces informations ; ne le partagez donc qu'avec la contrepartie concernée.</p>
      <h3>4. Services tiers que nous utilisons</h3>
  ...
  ru: {
    ...
    terms_modal_content: `<p>Последнее обновление: 22 августа 2026 г.</p>
      ...
      <h3>2. Это не юридическая консультация</h3>
      <p>Использование DraftB2B <strong>не является юридической консультацией</strong> и не создаёт отношений «адвокат-клиент» между вами и DraftB2B или любым лицом, связанным с проектом. Шаблоны предлагают общую отправную точку и не заменяют проверку лицензированным адвокатом в вашей юрисдикции, который сможет адаптировать содержание к вашему конкретному случаю, действующему местному законодательству и особенностям вашей деятельности.</p>
      <h3>3. Ответственность пользователя</h3>
      <p>Вы несёте ответственность за проверку, адаптацию и подтверждение любого документа, созданного с помощью этого инструмента, перед его подписанием, отправкой или любым использованием, имеющим юридические последствия. Мы настоятельно рекомендуем, чтобы окончательный документ проверил профессиональный юрист.</p>
      <h3>4. Отказ от гарантий</h3>
      <p>DraftB2B предоставляется «как есть» и «по мере доступности», без каких-либо гарантий, явных или подразумеваемых, включая (помимо прочего) гарантии пригодности для конкретной цели, точности, соответствия действующим нормам или применимости в конкретной юрисдикции.</p>
      <h3>5. Ограничение ответственности</h3>
      <p>В максимальной степени, разрешённой применимым законодательством, DraftB2B и лица, ответственные за его разработку, не несут ответственности за прямые, косвенные, случайные или косвенные убытки, возникшие в результате использования или невозможности использования документов, созданных с помощью этого инструмента.</p>
      <h3>6. Право собственности на созданные документы</h3>
      <p>Конкретное содержание, которое вы вводите в форму, и итоговый документ, который вы скачиваете, принадлежат вам. Код, дизайн, базовые шаблоны и функционирование платформы DraftB2B являются собственностью её разработчиков.</p>
      <h3>7. Допустимое использование</h3>
      <p>Вы обязуетесь не использовать этот инструмент для создания документов в незаконных, мошеннических целях или в целях, нарушающих права третьих лиц.</p>
      <h3>8. Изменения настоящих условий</h3>
      <p>Мы можем время от времени обновлять настоящие условия, отражая изменения в инструменте. Дата последнего обновления указана в начале этого документа.</p>`,
    privacy_modal_content: `<p>Последнее обновление: 22 августа 2026 г.</p>
      <h3>1. Архитектура, на 100% работающая на стороне клиента</h3>
      <p>У DraftB2B нет собственного серверного бэкенда. Вся обработка —составление документа, вычисление печати целостности SHA-256, генерация QR-кода, создание PDF и файла Word— происходит полностью в вашем собственном браузере, на вашем собственном устройстве. Ни одна из данных, которые вы вводите в форму (имена, адреса, налоговые идентификаторы, пункты, оцифрованные рукописные подписи, логотипы), не отправляется, не обрабатывается и не хранится ни на каком нашем сервере, потому что такого сервера не существует.</p>
      <h3>2. Использование локального хранилища (localStorage)</h3>
      <p>Для вашего удобства DraftB2B сохраняет определённую информацию только в локальном хранилище вашего собственного браузера (localStorage/sessionStorage), и она никогда не покидает ваше устройство:</p>
      <ul>
        <li>Автосохранение незавершённой формы, чтобы вы не потеряли свою работу при закрытии вкладки.</li>
        <li>Историю последних документов, созданных на этом устройстве.</li>
        <li>Шаблон, сохранённый вами вручную, если вы используете эту функцию.</li>
        <li>Ваши настройки языка и светлой/тёмной темы.</li>
        <li>Отметку о том, заполнили ли вы уже или закрыли уведомление о новых шаблонах, чтобы больше не показывать его вам.</li>
      </ul>
      <p>Вы можете удалить всю эту информацию в любой момент, очистив данные просмотра этого сайта в настройках вашего собственного браузера.</p>
      <h3>3. Ссылки для совместного доступа</h3>
      <p>Если вы используете функцию совместного доступа к предзаполненному черновику, данные формы кодируются непосредственно в самой ссылке —а не во внешней базе данных. Любой, кто получит эту ссылку, сможет увидеть эту информацию, поэтому делитесь ею только с соответствующей стороной.</p>
      <h3>4. Сторонние сервисы, которые мы используем</h3>
  ...
  zh: {
    ...
    terms_modal_content: `<p>最后更新：2026年8月22日。</p>
      ...
      <h3>2. 不构成法律意见</h3>
      <p>使用 DraftB2B <strong>不构成法律意见</strong>，也不会在您与 DraftB2B 或与该项目相关的任何人之间建立律师-客户关系。这些模板提供一个通用的起点，不能替代您所在司法管辖区持牌律师的审查——律师可以根据您的具体情况、当地现行法律以及您业务的特殊性来调整内容。</p>
      <h3>3. 用户责任</h3>
      <p>在签署、发送使用此工具生成的任何文档或将其用于任何具有法律效力的用途之前，您有责任对其进行审查、调整和验证。我们强烈建议由法律专业人士审查最终文档。</p>
      <h3>4. 免责声明</h3>
      <p>DraftB2B 按"现状"和"可用"提供，不提供任何形式的明示或暗示保证，包括（但不限于）对特定用途的适用性、准确性、法规时效性或在特定司法管辖区可执行性的保证。</p>
      <h3>5. 责任限制</h3>
      <p>在适用法律允许的最大范围内，DraftB2B 及其开发负责人对因使用或无法使用本工具生成的文档而产生的直接、间接、附带或后果性损害不承担责任。</p>
      <h3>6. 生成文档的所有权</h3>
      <p>您在表单中输入的具体内容以及您下载的最终文档归您所有。DraftB2B 平台的代码、设计、基础模板及其运作方式归其开发者所有。</p>
      <h3>7. 可接受的使用</h3>
      <p>您同意不会使用此工具生成用于非法、欺诈目的或侵犯第三方权利的文档。</p>
      <h3>8. 本条款的变更</h3>
      <p>我们可能会不定期更新本条款以反映工具的变化。文档开头标明了最后更新日期。</p>`,
    privacy_modal_content: `<p>最后更新：2026年8月22日。</p>
      <h3>1. 100% 客户端架构</h3>
      <p>DraftB2B 没有自己的后端服务器。所有处理过程——文档起草、SHA-256 完整性印记计算、二维码生成、PDF 和 Word 文件的创建——完全在您自己的浏览器、您自己的设备上进行。您在表单中输入的任何数据（姓名、地址、税务识别号、条款、数字化手写签名、徽标）都不会发送到、由我们的任何服务器处理或存储，因为这样的服务器根本不存在。</p>
      <h3>2. 本地存储（localStorage）的使用</h3>
      <p>为方便起见，DraftB2B 仅在您自己浏览器的本地存储（localStorage/sessionStorage）中保存某些信息，这些信息永远不会离开您的设备：</p>
      <ul>
        <li>正在进行的表单的自动保存，以便您在关闭标签页时不会丢失工作内容。</li>
        <li>此设备上最近生成的文档历史记录。</li>
        <li>如果您使用该功能，则包括您手动保存的模板。</li>
        <li>您的语言和浅色/深色主题偏好设置。</li>
        <li>标记您是否已完成或关闭了新模板通知提示，以免再次显示。</li>
      </ul>
      <p>您可以随时通过浏览器设置删除本网站的浏览数据，从而清除所有这些信息。</p>
      <h3>3. 分享链接</h3>
      <p>如果您使用分享预填草稿的功能，表单数据会直接编码在链接的 URL 本身中——而不是存储在外部数据库中。任何收到该链接的人都能看到这些信息，因此请仅与相应的对方分享。</p>
      <h3>4. 我们使用的第三方服务</h3>
  ...
  ja: {
    ...
    terms_modal_content: `<p>最終更新日：2026年8月22日。</p>
      ...
      <h3>2. 法的助言ではありません</h3>
      <p>DraftB2Bの利用は<strong>法的助言を構成するものではなく</strong>、お客様とDraftB2Bまたは本プロジェクトに関係する者との間に弁護士-依頼者関係を生じさせるものでもありません。テンプレートは一般的な出発点を提供するものであり、お客様の具体的な事案、適用される現地法、事業の特殊性に応じて内容を調整できる、お客様の管轄区域における弁護士資格を有する法律専門家によるレビューに代わるものではありません。</p>
      <h3>3. 利用者の責任</h3>
      <p>本ツールで生成した文書に署名、送付、または法的効力を持つ用途で使用する前に、内容を確認・調整・検証する責任はお客様にあります。最終的な文書については、法律専門家によるレビューを強くお勧めします。</p>
      <h3>4. 保証の免責</h3>
      <p>DraftB2Bは「現状有姿」および「提供可能な範囲」で提供され、特定目的への適合性、正確性、法規制への準拠、特定の管轄区域における執行可能性を含む（ただしこれらに限定されない）、明示または黙示を問わずいかなる保証も行いません。</p>
      <h3>5. 責任の制限</h3>
      <p>適用法が許容する最大限の範囲において、DraftB2Bおよびその開発に関与する者は、本ツールで生成された文書の使用または使用不能から生じる直接的、間接的、付随的、または結果的損害について責任を負いません。</p>
      <h3>6. 生成された文書の所有権</h3>
      <p>フォームに入力した具体的な内容、およびダウンロードした最終文書はお客様に帰属します。DraftB2Bプラットフォームのコード、デザイン、基本テンプレート、および動作方式はその開発者の所有物です。</p>
      <h3>7. 許容される利用</h3>
      <p>お客様は、本ツールを違法または詐欺的な目的、あるいは第三者の権利を侵害する目的で文書を生成するために使用しないことに同意するものとします。</p>
      <h3>8. 本規約の変更</h3>
      <p>ツールの変更を反映するため、本規約を随時更新する場合があります。最終更新日は本文書の冒頭に記載されています。</p>`,
    privacy_modal_content: `<p>最終更新日：2026年8月22日。</p>
      <h3>1. 100%クライアントサイドのアーキテクチャ</h3>
      <p>DraftB2Bは独自のバックエンドサーバーを持っていません。文書の作成、SHA-256完全性シールの計算、QRコードの生成、PDFおよびWordファイルの作成など、すべての処理はお客様自身のブラウザ内、お客様自身のデバイス上で完結します。フォームに入力するいかなるデータ（氏名、住所、税務識別番号、条項、デジタル化された手書き署名、ロゴ）も、当社のサーバーへ送信、処理、保存されることはありません。なぜなら、そのようなサーバー自体が存在しないからです。</p>
      <h3>2. ローカルストレージ（localStorage）の使用</h3>
      <p>利便性のため、DraftB2Bは特定の情報をお客様自身のブラウザのローカルストレージ（localStorage/sessionStorage）にのみ保存し、それがお客様のデバイスから外に出ることはありません：</p>
      <ul>
        <li>タブを閉じても作業内容を失わないようにするための、作業中のフォームの自動保存。</li>
        <li>このデバイスで生成された最近の文書の履歴。</li>
        <li>この機能を使用する場合、お客様が手動で保存したテンプレート。</li>
        <li>言語およびライト/ダークテーマの設定。</li>
        <li>新しいテンプレートの通知を再表示しないための、既に入力または閉じたかどうかを示すフラグ。</li>
      </ul>
      <p>これらの情報はいつでも、お客様自身のブラウザの設定からこのサイトの閲覧データを削除することで消去できます。</p>
      <h3>3. 共有リンク</h3>
      <p>入力済みの下書きを共有する機能を使用する場合、フォームのデータは外部データベースではなく、リンクのURL自体に直接エンコードされます。そのリンクを受け取った人は誰でもその情報を見ることができるため、該当する相手とのみ共有してください。</p>
      <h3>4. 当社が使用する第三者サービス</h3>
  ...
  hi: {
    ...
    terms_modal_content: `<p>अंतिम अद्यतन: 22 अगस्त, 2026।</p>
      ...
      <h3>2. यह कानूनी सलाह नहीं है</h3>
      <p>DraftB2B का उपयोग <strong>कानूनी सलाह नहीं है</strong> और यह आपके और DraftB2B या परियोजना से जुड़े किसी भी व्यक्ति के बीच वकील-मुवक्किल संबंध नहीं बनाता। टेम्पलेट्स एक सामान्य शुरुआती बिंदु प्रदान करते हैं और आपके क्षेत्राधिकार में एक लाइसेंस प्राप्त वकील की समीक्षा का स्थान नहीं लेते, जो सामग्री को आपके विशिष्ट मामले, लागू स्थानीय कानून और आपके व्यवसाय की विशिष्टताओं के अनुसार अनुकूलित कर सकता है।</p>
      <h3>3. उपयोगकर्ता की जिम्मेदारी</h3>
      <p>इस उपकरण से उत्पन्न किसी भी दस्तावेज़ पर हस्ताक्षर करने, भेजने या किसी भी कानूनी रूप से बाध्यकारी उपयोग में लाने से पहले उसकी समीक्षा, अनुकूलन और सत्यापन करने की जिम्मेदारी आपकी है। हम दृढ़ता से अनुशंसा करते हैं कि अंतिम दस्तावेज़ की समीक्षा एक कानूनी पेशेवर द्वारा की जाए।</p>
      <h3>4. वारंटी अस्वीकरण</h3>
      <p>DraftB2B "जैसा है" और "जैसा उपलब्ध है" के आधार पर प्रदान किया जाता है, बिना किसी प्रकार की स्पष्ट या निहित वारंटी के, जिसमें (बिना सीमा के) किसी विशेष उद्देश्य के लिए उपयुक्तता, सटीकता, नियामक अद्यतन या किसी विशिष्ट क्षेत्राधिकार में प्रवर्तनीयता की वारंटी शामिल है।</p>
      <h3>5. दायित्व की सीमा</h3>
      <p>लागू कानून द्वारा अनुमत अधिकतम सीमा तक, DraftB2B और इसके विकास के लिए जिम्मेदार व्यक्ति इस उपकरण से उत्पन्न दस्तावेज़ों के उपयोग या उपयोग करने में असमर्थता से उत्पन्न प्रत्यक्ष, अप्रत्यक्ष, आकस्मिक या परिणामी क्षति के लिए उत्तरदायी नहीं होंगे।</p>
      <h3>6. जनरेट किए गए दस्तावेज़ों का स्वामित्व</h3>
      <p>आपके द्वारा फ़ॉर्म में दर्ज की गई विशिष्ट सामग्री और आपके द्वारा डाउनलोड किया गया अंतिम दस्तावेज़ आपका है। DraftB2B प्लेटफ़ॉर्म का कोड, डिज़ाइन, आधार टेम्पलेट्स और कार्यप्रणाली इसके डेवलपर्स की संपत्ति है।</p>
      <h3>7. स्वीकार्य उपयोग</h3>
      <p>आप सहमत हैं कि आप इस उपकरण का उपयोग अवैध, धोखाधड़ीपूर्ण उद्देश्यों के लिए या तीसरे पक्ष के अधिकारों का उल्लंघन करने वाले दस्तावेज़ बनाने के लिए नहीं करेंगे।</p>
      <h3>8. इन शर्तों में परिवर्तन</h3>
      <p>हम उपकरण में परिवर्तनों को दर्शाने के लिए इन शर्तों को समय-समय पर अपडेट कर सकते हैं। अंतिम अद्यतन की तिथि इस दस्तावेज़ के शीर्ष पर दर्शाई गई है।</p>`,
    privacy_modal_content: `<p>अंतिम अद्यतन: 22 अगस्त, 2026।</p>
      <h3>1. 100% क्लाइंट-साइड आर्किटेक्चर</h3>
      <p>DraftB2B के पास अपना कोई बैकएंड सर्वर नहीं है। सारी प्रोसेसिंग —दस्तावेज़ का प्रारूपण, SHA-256 अखंडता मुहर की गणना, QR कोड जनरेशन, PDF और Word फ़ाइल का निर्माण— पूरी तरह से आपके अपने ब्राउज़र में, आपके अपने डिवाइस पर होती है। आपके द्वारा फ़ॉर्म में दर्ज किया गया कोई भी डेटा (नाम, पते, कर पहचान संख्या, धाराएं, डिजिटाइज़्ड हस्तलिखित हस्ताक्षर, लोगो) हमारे किसी भी सर्वर पर नहीं भेजा जाता, संसाधित नहीं होता, या संग्रहीत नहीं होता, क्योंकि ऐसा सर्वर मौजूद ही नहीं है।</p>
      <h3>2. लोकल स्टोरेज (localStorage) का उपयोग</h3>
      <p>आपकी सुविधा के लिए, DraftB2B कुछ जानकारी केवल आपके अपने ब्राउज़र के लोकल स्टोरेज (localStorage/sessionStorage) में संग्रहीत करता है, जो कभी भी आपके डिवाइस से बाहर नहीं जाती:</p>
      <ul>
        <li>प्रगति पर मौजूद फ़ॉर्म का ऑटो-सेव, ताकि टैब बंद करने पर आपका काम न खोए।</li>
        <li>इस डिवाइस पर हाल ही में जनरेट किए गए दस्तावेज़ों का इतिहास।</li>
        <li>आपके द्वारा मैन्युअल रूप से सहेजा गया एक टेम्पलेट, यदि आप उस सुविधा का उपयोग करते हैं।</li>
        <li>आपकी भाषा और लाइट/डार्क थीम प्राथमिकताएं।</li>
        <li>यह संकेतक कि क्या आपने पहले ही नए टेम्पलेट सूचना संदेश को पूरा कर लिया है या खारिज कर दिया है, ताकि इसे दोबारा न दिखाया जाए।</li>
      </ul>
      <p>आप अपने ब्राउज़र की सेटिंग्स से इस साइट का ब्राउज़िंग डेटा हटाकर किसी भी समय इस सारी जानकारी को मिटा सकते हैं।</p>
      <h3>3. साझा करने योग्य लिंक</h3>
      <p>यदि आप पहले से भरे गए ड्राफ्ट को साझा करने की सुविधा का उपयोग करते हैं, तो फ़ॉर्म डेटा सीधे लिंक की स्वयं की URL के भीतर एन्कोड किया जाता है —किसी बाहरी डेटाबेस में नहीं। उस लिंक को प्राप्त करने वाला कोई भी व्यक्ति उस जानकारी को देख सकता है, इसलिए इसे केवल संबंधित पक्ष के साथ ही साझा करें।</p>
      <h3>4. हमारे द्वारा उपयोग की जाने वाली तृतीय-पक्ष सेवाएं</h3>
...
const PP_I18N = {
  ...
  de: {
    tpl_privacy_title: "Datenschutzerklärung",
    tpl_privacy_desc: "Dokument zum Schutz personenbezogener Daten für Ihre Website oder App.",
    tpl_privacy_short: "Datenschutz",
    role_data_controller: "Verantwortlicher",
    role_data_subject: "Betroffene Person",
    doc_title_privacy_policy: "Datenschutzerklärung",
    intro_privacy: "Diese Datenschutzerklärung beschreibt, wie {roleA}, identifiziert als {nameA}, personenbezogene Daten von Nutzern und Besuchern gemäß den geltenden Datenschutzvorschriften erhebt, verwendet, aufbewahrt und schützt.",
    c1_title_pp: "Verantwortlicher",
    c1_body_pp: "Verantwortlicher für die Verarbeitung personenbezogener Daten ist {roleA}, mit der Kennung {idA} und Sitz in {addrA}. Fragen zu dieser Erklärung können an die am Ende dieses Dokuments angegebenen Kontaktdaten gerichtet werden.",
    c2_title_pp: "Von uns erhobene personenbezogene Daten",
    c2_body_pp: "Wir können Identifikations- und Kontaktdaten (wie Name, E-Mail-Adresse oder Telefonnummer), Nutzungsdaten (IP-Adresse, Gerätetyp, besuchte Seiten) sowie alle sonstigen Daten erheben, die der Nutzer freiwillig über Formulare, Konten oder Mitteilungen bereitstellt.",
    c3_title_pp: "Zweck der Verarbeitung",
    c3_body_pp: "Personenbezogene Daten werden zu folgendem Zweck verarbeitet: {purpose} Sie können darüber hinaus zur Verbesserung des Dienstes, zur Beantwortung von Anfragen und zur Erfüllung gesetzlicher Pflichten verwendet werden.",
    c4_title_pp: "Rechtsgrundlage",
    c4_body_pp: "Die Verarbeitung stützt sich auf die Einwilligung der betroffenen Person, die Erfüllung eines Vertrags- oder Geschäftsverhältnisses sowie die Erfüllung gesetzlicher Pflichten, die für {roleA} gelten.",
    c5_title_pp: "Aufbewahrungsfrist",
    c5_body_pp: "Personenbezogene Daten werden für {duration} aufbewahrt, oder so lange, wie es zur Erfüllung des Zwecks, zu dem sie erhoben wurden, unbedingt erforderlich ist, sofern nicht eine gesetzliche Pflicht eine längere Aufbewahrungsfrist vorschreibt.",
    c6_title_pp: "Empfänger und Auftragsverarbeiter",
    c6_body_pp: "Daten können an Dienstleister (Hosting, Analyse, Zahlungen) weitergegeben werden, die als Auftragsverarbeiter im Auftrag von {roleA} handeln, sowie an zuständige Behörden, sofern gesetzlich vorgeschrieben.",
    c7_title_pp: "Internationale Datenübermittlungen",
    c7_body_pp: "Sollten Daten außerhalb des Landes oder der Region übermittelt werden, in der sich {roleB} befindet, wird {roleA} die nach geltendem Recht erforderlichen geeigneten Garantien umsetzen, um ein gleichwertiges Schutzniveau sicherzustellen.",
    c8_title_pp: "Rechte der betroffenen Person",
    c8_body_pp: "{roleB} kann nach Maßgabe des Gesetzes seine Rechte auf Auskunft, Berichtigung, Löschung oder Widerspruch sowie, soweit anwendbar, auf Datenübertragbarkeit und Einschränkung der Verarbeitung ausüben, indem er sich über die angegebenen Kontaktdaten an {roleA} wendet.",
    c9_title_pp: "Verwendung von Cookies und ähnlichen Technologien",
    c9_body_pp: "Diese Website oder Anwendung kann Cookies oder ähnliche Technologien verwenden, um die Nutzererfahrung zu verbessern, den Datenverkehr zu analysieren und Inhalte zu personalisieren; {roleB} kann seine Einstellungen über die Browsereinstellungen konfigurieren.",
    c10_title_pp: "Anwendbares Recht",
    c10_body_pp: "Diese Datenschutzerklärung unterliegt dem in {jurisdiction} geltenden Datenschutzrecht, unbeschadet anderer zwingend anwendbarer Vorschriften.",
    c11_title_pp: "Änderungen dieser Erklärung und Kontakt",
    c11_body_pp: "{roleA} kann diese Datenschutzerklärung aktualisieren, um rechtlichen, technischen oder betrieblichen Änderungen Rechnung zu tragen, und veröffentlicht die jeweils aktuelle Fassung über denselben Kanal. Bei Fragen zur Datenverarbeitung kann sich {roleB} über die in diesem Dokument angegebenen Angaben direkt an {roleA} wenden.",
    sign_place_date_pp: "Diese Datenschutzerklärung tritt zu dem unten angegebenen Datum in Kraft:",
    label_object_pp: "Beschreibung der Daten und Zweck der Verarbeitung",
    label_duration_pp: "Aufbewahrungsfrist der Daten",
    party_a_legend_pp: "Verantwortlicher",
    checklist_item1_pp: "Ich habe die Identität und Angaben des Verantwortlichen überprüft",
    checklist_item2_pp: "Der Umfang der erhobenen Daten und ihr Zweck sind klar definiert",
    checklist_item3_pp: "Das anwendbare Datenschutzrecht ist korrekt",
    verify_link_label: "Öffentlicher Verifizierungslink",
    verify_copy_btn: "Link kopieren",
    verify_link_hint: "Jeder, der über diesen Link (oder den QR-Code des Dokuments) verfügt, kann überprüfen, dass der Inhalt nicht verändert wurde.",
  },
  pt: {
...
const V2_I18N = {
  ...
  de: {
    ...
    info_tab_benefits: "Warum DraftB2B?",
    info_tab_guide: "Rechtsleitfaden",
    info_tab_faq: "FAQ",
    info_tab_glossary: "Glossar",
    zoom_out: "Verkleinern",
    zoom_in: "Vergrößern",
    badge_active: "Aktiv",
    btn_print: "Drucken",
    btn_ics: "Ablauferinnerung",
    ics_no_duration: "Dieses Dokument hat eine unbefristete Laufzeit; es kann keine Ablauferinnerung erstellt werden.",
    ics_event_title: "Ablauf: {ref}",
    ics_event_desc: "Automatische, von DraftB2B für das Dokument {ref} erstellte Erinnerung. Prüfen Sie, ob die Vereinbarung verlängert, aktualisiert oder beendet werden muss.",
    ics_downloaded_msg: "Erinnerung (.ics) heruntergeladen",
    glossary_title: "Rechtsglossar",
    glossary_subtitle: "Rechtsbegriffe einfach erklärt.",
    glossary_search_placeholder: "Einen Begriff suchen...",
    glossary_empty: "Keine Begriffe entsprechen Ihrer Suche.",
    glossary_term_nda: "NDA (Geheimhaltungsvereinbarung)",
    glossary_def_nda: "Ein Vertrag, in dem sich eine oder beide Parteien verpflichten, die zwischen ihnen ausgetauschten vertraulichen Informationen nicht offenzulegen. Auch Vertraulichkeitsvereinbarung genannt.",
    glossary_term_noncompete: "Wettbewerbsverbotsklausel",
    glossary_def_noncompete: "Eine Bestimmung, die eine Partei für einen bestimmten Zeitraum daran hindert, ein direkt konkurrierendes Geschäft zu betreiben, üblicherweise während der Laufzeit der Vereinbarung.",
    glossary_term_nonsolicit: "Abwerbeverbotsklausel",
    glossary_def_nonsolicit: "Untersagt einer Partei, Mitarbeiter, Auftragnehmer oder Kunden der anderen Partei einzustellen oder dies zu versuchen, solange die Vereinbarung in Kraft ist.",
    glossary_term_arbitration: "Handelsschiedsverfahren",
    glossary_def_arbitration: "Ein Streitbeilegungsverfahren außerhalb der ordentlichen Gerichte, bei dem ein neutraler Dritter (Schiedsrichter) eine für beide Parteien bindende Entscheidung trifft.",
    glossary_term_penalty: "Vertragsstrafenklausel",
    glossary_def_penalty: "Eine Bestimmung, die den von der vertragsbrüchigen Partei geschuldeten Entschädigungsbetrag im Voraus festlegt und so den Nachweis des genauen Schadens erübrigt.",
    glossary_term_controller: "Verantwortlicher",
    glossary_def_controller: "Die natürliche oder juristische Person, die über Zweck und Mittel der Verarbeitung personenbezogener Daten entscheidet und die rechtlichen Pflichten gegenüber den betroffenen Personen trägt.",
    glossary_term_subject: "Betroffene Person",
    glossary_def_subject: "Die natürliche Person, auf die sich die erhobenen oder verarbeiteten personenbezogenen Daten beziehen und die Rechte auf Auskunft, Berichtigung, Löschung oder Widerspruch ausüben kann.",
    glossary_term_legalbasis: "Rechtsgrundlage",
    glossary_def_legalbasis: "Die rechtliche Grundlage, die die Verarbeitung personenbezogener Daten rechtmäßig macht: unter anderem die Einwilligung der betroffenen Person, die Vertragserfüllung oder die Erfüllung einer gesetzlichen Pflicht.",
    glossary_term_transfer: "Internationale Datenübermittlung",
    glossary_def_transfer: "Die Übermittlung personenbezogener Daten in ein anderes Land oder eine andere Region als die, in der die betroffene Person ansässig ist, was in der Regel zusätzliche Garantien für ein gleichwertiges Schutzniveau erfordert.",
    glossary_term_esignature: "Elektronische Signatur",
    glossary_def_esignature: "Eine Reihe elektronischer Daten, die zur Identifizierung des Unterzeichners eines Dokuments und zur Bestätigung seiner Zustimmung zum Inhalt dienen, mit je nach Rechtsordnung unterschiedlicher Rechtsgültigkeit.",
    email_capture_title: "Möchten Sie von neuen Vorlagen erfahren?",
    email_capture_desc: "Hinterlassen Sie uns Ihre E-Mail-Adresse, und wir informieren Sie, sobald wir neue Vorlagen und Funktionen veröffentlichen. Kein Spam.",
    email_capture_placeholder: "sie@email.de",
    email_capture_btn: "Benachrichtigen",
    email_capture_error: "Geben Sie eine gültige E-Mail-Adresse ein.",
    email_capture_thanks: "Danke! Wir informieren Sie über Neuigkeiten.",
    email_capture_network_error: "Senden fehlgeschlagen. Bitte versuchen Sie es erneut.",
  },
  pt: {
...
const V3_I18N = {
  ...
  de: {
    role_assignor: "Der Zedent",
    role_assignee: "Der Zessionar",
    doc_title_ip_assignment: "Vertrag über die Übertragung von geistigem Eigentum",
    intro_ip: "Der vorliegende Vertrag über die Übertragung von geistigem Eigentum (nachfolgend der „Vertrag\") wird geschlossen zwischen {nameA}, ausgewiesen mit {idA} und ansässig in {addrA} (nachfolgend „{roleA}\"); und {nameB}, ausgewiesen mit {idB} und ansässig in {addrB} (nachfolgend „{roleB}\"), gemeinsam die „Parteien\", zu folgenden Bedingungen:",
    c1_title_ip: "Gegenstand der Übertragung",
    c1_body_ip: "Mit diesem Vertrag überträgt {roleA} {roleB} auf {duration} Basis sämtliche Rechte des geistigen Eigentums an dem nachfolgend beschriebenen Werk, der Entwicklung oder Schöpfung: {purpose}",
    c2_title_ip: "Umfang der übertragenen Rechte",
    c2_body_ip: "Die Übertragung umfasst, ohne Beschränkung, die Vermögensrechte zur Vervielfältigung, Verbreitung, Bearbeitung, öffentlichen Wiedergabe und wirtschaftlichen Verwertung des Werks, in jedem gegenwärtig bekannten oder künftig entwickelten Format oder Medium.",
    c3_title_ip: "Erklärung der ursprünglichen Inhaberschaft",
    c3_body_ip: "{roleA} erklärt, der ursprüngliche Urheber und alleinige Inhaber der zu übertragenden Rechte zu sein, und dass das Werk keine Rechte Dritter verletzt.",
    c4_title_ip: "Urheberpersönlichkeitsrechte",
    c4_body_ip: "Soweit nach geltendem Recht zulässig, verzichtet {roleA} auf die Ausübung von Urheberpersönlichkeitsrechten, die mit der übertragenen Verwertung unvereinbar wären, unbeschadet des Rechts auf Anerkennung der Urheberschaft, soweit anwendbar.",
    c5_title_ip: "Gegenleistung",
    c5_body_ip: "Die Übertragung der Rechte erfolgt gegen die zwischen den Parteien vereinbarte Gegenleistung, deren Erhalt {roleA} bei Unterzeichnung dieses Dokuments als zufriedenstellend bestätigt.",
    c6_title_ip: "Garantien des Zedenten",
    c6_body_ip: "{roleA} garantiert, über die volle Fähigkeit und Inhaberschaft zur Durchführung dieser Übertragung zu verfügen, und dass das Werk frei von Belastungen, früheren Lizenzen oder Ansprüchen Dritter ist.",
    c7_title_ip: "Weitere Unterstützung",
    c7_body_ip: "{roleA} verpflichtet sich, alle zusätzlichen Dokumente zu unterzeichnen, die vernünftigerweise erforderlich sind, um die übertragenen Rechte bei Behörden oder Registern für geistiges Eigentum zu formalisieren, einzutragen oder zu schützen.",
    c8_title_ip: "Anwendbares Recht und Gerichtsstand",
    c8_body_ip: "Dieser Vertrag unterliegt dem in {jurisdiction} geltenden Recht. Für jede Streitigkeit, die sich aus seiner Auslegung oder Erfüllung ergibt, unterwerfen sich die Parteien den zuständigen Gerichten dieser Rechtsordnung.",
    tpl_ip_title: "Übertragung von geistigem Eigentum",
    tpl_ip_desc: "Überträgt das Eigentum an einem Werk, einer Entwicklung oder Schöpfung.",
    tpl_ip_short: "Geist. Eigentum",
    party_a_legend_ip: "Der Zedent",
    party_b_legend_ip: "Der Zessionar",
    label_object_ip: "Beschreibung des übertragenen Werks, der Entwicklung oder Schöpfung",
    label_duration_ip: "Zeitlicher Umfang der Übertragung",
    label_country: "Referenzland (optional)",
    country_hint: "Passt automatisch das Format der Steuernummer an und schlägt den Gerichtsstand je nach Land vor.",
    country_generic: "Allgemein / Andere",
    country_mx: "Mexiko", country_es: "Spanien", country_us: "Vereinigte Staaten",
    country_ar: "Argentinien", country_co: "Kolumbien", country_cl: "Chile",
    country_br: "Brasilien", country_pe: "Peru", country_gb: "Vereinigtes Königreich",
    btn_history: "Dokumentenverlauf",
    history_modal_title: "Meine Dokumente",
    history_modal_desc: "Ein lokales, nur in diesem Browser gespeichertes Verzeichnis der von Ihnen erstellten Dokumente.",
    history_empty: "Sie haben noch kein Dokument erstellt.",
    history_clear_btn: "Verlauf löschen",
    history_clear_confirm: "Möchten Sie Ihren Dokumentenverlauf wirklich löschen? Dies kann nicht rückgängig gemacht werden.",
    history_clear_done: "Verlauf gelöscht.",
    history_signed_yes: "Unterzeichnet",
    history_signed_no: "Nicht unterzeichnet",
  },
  pt: {
...
const V4_I18N = {
  ...
  de: {
    sheet_title: "Weitere Aktionen",
    btn_more_actions: "Weitere Optionen",
    btn_copy_md: "Als Markdown kopieren",
    btn_sheet_close: "Schließen",
    tpl_settlement_title: "Abnahmeprotokoll / Abschlussvereinbarung",
    tpl_settlement_desc: "Schließt ein Dienstleistungsprojekt mit Abnahme und Abschlussvereinbarung ab.",
    tpl_settlement_short: "Abschluss",
    doc_title_settlement: "Abnahme- und Abschlussprotokoll für Dienstleistungen",
    intro_settlement: "Das vorliegende Abnahme- und Abschlussprotokoll für Dienstleistungen (nachfolgend das „Dokument\") wird geschlossen zwischen {nameA}, ausgewiesen mit {idA} und ansässig in {addrA} (nachfolgend „{roleA}\"); und {nameB}, ausgewiesen mit {idB} und ansässig in {addrB} (nachfolgend „{roleB}\"), gemeinsam die „Parteien\", zu folgenden Bedingungen:",
    label_object_settlement: "Beschreibung der Dienstleistungen oder Leistungsergebnisse",
    label_duration_settlement: "Gewährleistungsfrist nach Lieferung (falls zutreffend)",
    c1_title_settlement: "Gegenstand der Lieferung",
    c1_body_settlement: "{roleA} erklärt, die nachfolgend beschriebenen Dienstleistungen, Arbeiten oder Leistungsergebnisse abgeschlossen und an {roleB} geliefert zu haben: {purpose}",
    c2_title_settlement: "Abnahme und Übereinstimmung",
    c2_body_settlement: "{roleB} erklärt, die oben beschriebenen Leistungsergebnisse geprüft zu haben und nimmt sie zur vollen Zufriedenheit ab, ohne ausstehende Einwände, sofern nicht schriftlich anders angegeben.",
    c3_title_settlement: "Abschlussvereinbarung und Entlastung von Verpflichtungen",
    c3_body_settlement: "Die Parteien erteilen sich gegenseitig eine Abschlussvereinbarung für die von diesem Dokument erfassten Dienstleistungen und entlasten sich gegenseitig von Verbindlichkeiten aus deren Erfüllung, unbeschadet etwaiger Gewährleistungs- und Geheimhaltungspflichten, die ausdrücklich über die Beendigung hinaus fortbestehen.",
    c4_title_settlement: "Ausstehende Zahlungen",
    c4_body_settlement: "Zum Zeitpunkt der Unterzeichnung erklärt {roleA}, dass die vereinbarten Zahlungen für die erbrachten Dienstleistungen von {roleB} vollständig beglichen wurden, sofern nicht ein ausstehender Restbetrag und dessen Zahlungsdatum anderweitig angegeben sind.",
    c5_title_settlement: "Anwendbares Recht und Gerichtsstand",
    c5_body_settlement: "Dieses Dokument unterliegt dem in {jurisdiction} geltenden Recht. Für jede Streitigkeit, die sich aus seiner Auslegung oder Erfüllung ergibt, unterwerfen sich die Parteien den zuständigen Gerichten dieser Rechtsordnung.",
  },
  pt: {
...
// V5: "Capacidades" (Feature Matrix) info-tab panel + navbar shortcut.
const V5_I18N = {
  es: {
    nav_capabilities: "Capacidades",
    info_tab_capabilities: "Capacidades",
    cap_1_title: "Generación Multidocumento",
    cap_1_desc: "NDAs unilaterales, acuerdos bilaterales mutuos, contratos B2B de servicios, políticas de privacidad y actas de finiquito, adaptados a normativas vigentes.",
    cap_2_title: "Redacción Bilingüe Simultánea",
    cap_2_desc: "Genera y exporta en doble columna, en paralelo, en 8 idiomas (ES, EN, PT, FR, RU, ZH, JA, HI) sin desfases de alineación.",
    cap_3_title: "Firma Digital y Personalización de Marca",
    cap_3_desc: "Lienzo táctil para trazar tu firma manuscrita digitalizada e incorporar el membrete o logotipo de tu empresa en alta resolución.",
    cap_4_title: "Sello Criptográfico de Integridad",
    cap_4_desc: "Timbrado digital con hash SHA-256 en tiempo real y código QR de validación al pie de cada documento, para detectar cualquier alteración.",
    cap_5_title: "Colaboración Segura sin Servidor",
    cap_5_desc: "Comparte borradores prellenados mediante un enlace comprimido en la URL: cero almacenamiento en bases de datos externas, 100% privado.",
    cap_6_title: "Exportación Multiformato de Alta Fidelidad",
    cap_6_desc: "Descarga instantánea en PDF maquetado con márgenes de seguridad, Word (.docx) editable en columnas 50/50, y copiado directo en Markdown.",
  },
  en: {
    nav_capabilities: "Capabilities",
    info_tab_capabilities: "Capabilities",
    cap_1_title: "Multi-Document Generation",
    cap_1_desc: "Unilateral NDAs, mutual bilateral agreements, B2B services contracts, privacy policies, and service settlement acts, adapted to current regulations.",
    cap_2_title: "Simultaneous Bilingual Drafting",
    cap_2_desc: "Generate and export side-by-side, in parallel, in 8 languages (ES, EN, PT, FR, RU, ZH, JA, HI) with no alignment drift.",
    cap_3_title: "Digital Signature and Brand Customization",
    cap_3_desc: "A touch canvas to draw your digitized handwritten signature and add your company's letterhead or logo in high resolution.",
    cap_4_title: "Cryptographic Integrity Seal",
    cap_4_desc: "Real-time SHA-256 hash stamping and a validation QR code at the foot of every document, to detect any alteration.",
    cap_5_title: "Secure Serverless Collaboration",
    cap_5_desc: "Share pre-filled drafts via a compressed URL link: zero storage on external databases, 100% private.",
    cap_6_title: "High-Fidelity Multi-Format Export",
    cap_6_desc: "Instant download as a laid-out PDF with safety margins, an editable Word (.docx) in 50/50 columns, and a direct Markdown copy.",
  },
  de: {
    nav_capabilities: "Funktionen",
    info_tab_capabilities: "Funktionen",
    cap_1_title: "Mehrfach-Dokumentenerstellung",
    cap_1_desc: "Einseitige NDAs, gegenseitige zweiseitige Vereinbarungen, B2B-Dienstleistungsverträge, Datenschutzerklärungen und Abnahme-/Abschlussprotokolle, angepasst an die geltenden Vorschriften.",
    cap_2_title: "Gleichzeitige zweisprachige Erstellung",
    cap_2_desc: "Erstellen und exportieren Sie parallel in zweispaltiger Ansicht in 8 Sprachen (ES, EN, PT, FR, RU, ZH, JA, HI) ohne Ausrichtungsabweichungen.",
    cap_3_title: "Digitale Unterschrift und Markenanpassung",
    cap_3_desc: "Ein Touch-Feld zum Zeichnen Ihrer digitalisierten handschriftlichen Unterschrift und zum Hinzufügen des Firmenbriefkopfs oder Logos in hoher Auflösung.",
    cap_4_title: "Kryptografisches Integritätssiegel",
    cap_4_desc: "Echtzeit-SHA-256-Hash-Stempelung und ein Validierungs-QR-Code am Fuß jedes Dokuments, um jede Änderung zu erkennen.",
    cap_5_title: "Sichere serverlose Zusammenarbeit",
    cap_5_desc: "Teilen Sie vorausgefüllte Entwürfe über einen komprimierten URL-Link: keine Speicherung in externen Datenbanken, 100% privat.",
    cap_6_title: "Hochwertiger Multiformat-Export",
    cap_6_desc: "Sofortiger Download als layoutetes PDF mit Sicherheitsrändern, ein bearbeitbares Word-Dokument (.docx) in 50/50-Spalten und eine direkte Markdown-Kopie.",
  },
  pt: {
    nav_capabilities: "Capacidades",
    info_tab_capabilities: "Capacidades",
    cap_1_title: "Geração Multidocumento",
    cap_1_desc: "NDAs unilaterais, acordos bilaterais mútuos, contratos B2B de serviços, políticas de privacidade e termos de quitação de serviços, adaptados às normas vigentes.",
    cap_2_title: "Redação Bilíngue Simultânea",
    cap_2_desc: "Gere e exporte em coluna dupla, em paralelo, em 8 idiomas (ES, EN, PT, FR, RU, ZH, JA, HI) sem desalinhamentos.",
    cap_3_title: "Assinatura Digital e Personalização de Marca",
    cap_3_desc: "Uma tela sensível ao toque para desenhar sua assinatura manuscrita digitalizada e incluir o timbre ou logotipo da sua empresa em alta resolução.",
    cap_4_title: "Selo Criptográfico de Integridade",
    cap_4_desc: "Carimbo digital com hash SHA-256 em tempo real e código QR de validação no rodapé de cada documento, para detectar qualquer alteração.",
    cap_5_title: "Colaboração Segura sem Servidor",
    cap_5_desc: "Compartilhe rascunhos pré-preenchidos por meio de um link de URL comprimido: zero armazenamento em bancos de dados externos, 100% privado.",
    cap_6_title: "Exportação Multiformato de Alta Fidelidade",
    cap_6_desc: "Baixe instantaneamente em PDF diagramado com margens de segurança, Word (.docx) editável em colunas 50/50, e copie diretamente em Markdown.",
  },
  fr: {
    nav_capabilities: "Capacités",
    info_tab_capabilities: "Capacités",
    cap_1_title: "Génération Multi-Documents",
    cap_1_desc: "NDA unilatéraux, accords bilatéraux mutuels, contrats B2B de services, politiques de confidentialité et procès-verbaux de solde de tout compte, adaptés aux réglementations en vigueur.",
    cap_2_title: "Rédaction Bilingue Simultanée",
    cap_2_desc: "Générez et exportez en double colonne, en parallèle, en 8 langues (ES, EN, PT, FR, RU, ZH, JA, HI) sans décalage d'alignement.",
    cap_3_title: "Signature Numérique et Personnalisation de Marque",
    cap_3_desc: "Un pavé tactile pour tracer votre signature manuscrite numérisée et intégrer l'en-tête ou le logo de votre entreprise en haute résolution.",
    cap_4_title: "Sceau Cryptographique d'Intégrité",
    cap_4_desc: "Horodatage numérique avec hachage SHA-256 en temps réel et code QR de validation au bas de chaque document, pour détecter toute altération.",
    cap_5_title: "Collaboration Sécurisée Sans Serveur",
    cap_5_desc: "Partagez des brouillons pré-remplis via un lien d'URL compressé : aucun stockage sur des bases de données externes, 100 % privé.",
    cap_6_title: "Export Multi-Format Haute Fidélité",
    cap_6_desc: "Téléchargement instantané en PDF mis en page avec marges de sécurité, Word (.docx) éditable en colonnes 50/50, et copie directe au format Markdown.",
  },
  ru: {
    nav_capabilities: "Возможности",
    info_tab_capabilities: "Возможности",
    cap_1_title: "Генерация Разных Типов Документов",
    cap_1_desc: "Односторонние NDA, двусторонние взаимные соглашения, B2B договоры об оказании услуг, политики конфиденциальности и акты взаиморасчётов по услугам — адаптированные под действующие нормы.",
    cap_2_title: "Одновременное Двуязычное Составление",
    cap_2_desc: "Создавайте и экспортируйте документ в две колонки параллельно на 8 языках (ES, EN, PT, FR, RU, ZH, JA, HI) без смещения выравнивания.",
    cap_3_title: "Цифровая Подпись и Брендирование",
    cap_3_desc: "Сенсорный холст для рисования оцифрованной рукописной подписи и добавления фирменного бланка или логотипа компании в высоком разрешении.",
    cap_4_title: "Криптографическая Печать Целостности",
    cap_4_desc: "Цифровое штампование с хешем SHA-256 в реальном времени и QR-кодом проверки внизу каждого документа для обнаружения любых изменений.",
    cap_5_title: "Безопасное Взаимодействие Без Сервера",
    cap_5_desc: "Делитесь предзаполненными черновиками через сжатую ссылку URL: без хранения во внешних базах данных, на 100% приватно.",
    cap_6_title: "Экспорт в Разные Форматы с Высокой Точностью",
    cap_6_desc: "Мгновенное скачивание в виде свёрстанного PDF с защитными полями, редактируемого Word (.docx) в колонках 50/50 и прямого копирования в Markdown.",
  },
  zh: {
    nav_capabilities: "功能",
    info_tab_capabilities: "功能",
    cap_1_title: "多文档生成",
    cap_1_desc: "单方保密协议、双方相互协议、B2B服务合同、隐私政策以及服务结算书，均根据现行法规进行调整。",
    cap_2_title: "双语同步撰写",
    cap_2_desc: "以8种语言（西、英、葡、法、俄、中、日、印地语）并行生成并导出双栏文档，不会出现对齐偏差。",
    cap_3_title: "数字签名与品牌定制",
    cap_3_desc: "触控画布可绘制数字化手写签名，并以高分辨率添加公司抬头或标志。",
    cap_4_title: "加密完整性印记",
    cap_4_desc: "实时生成SHA-256哈希戳记，并在每份文档底部附带验证二维码，以便发现任何篡改。",
    cap_5_title: "无服务器安全协作",
    cap_5_desc: "通过压缩的URL链接分享预填草稿：不在外部数据库中存储任何数据，100%私密。",
    cap_6_title: "高保真多格式导出",
    cap_6_desc: "即时下载带安全边距排版的PDF、可编辑的50/50双栏Word（.docx）文档，并可直接复制为Markdown格式。",
  },
  ja: {
    nav_capabilities: "機能",
    info_tab_capabilities: "機能",
    cap_1_title: "マルチドキュメント生成",
    cap_1_desc: "片務型NDA、双務型（相互）契約、B2Bサービス契約、プライバシーポリシー、サービス精算書を、現行法規に合わせて作成できます。",
    cap_2_title: "同時バイリンガル作成",
    cap_2_desc: "8言語（ES、EN、PT、FR、RU、ZH、JA、HI）で並行して2段組みで生成・書き出しでき、レイアウトのずれもありません。",
    cap_3_title: "電子署名とブランドカスタマイズ",
    cap_3_desc: "タッチ操作でデジタル化した手書き署名を描き、高解像度の会社レターヘッドやロゴを追加できます。",
    cap_4_title: "暗号による完全性シール",
    cap_4_desc: "リアルタイムのSHA-256ハッシュ刻印と、各文書の末尾に検証用QRコードを付与し、あらゆる改ざんを検知します。",
    cap_5_title: "サーバーレスの安全な共同作業",
    cap_5_desc: "圧縮されたURLリンクで入力済みの下書きを共有：外部データベースへの保存は一切なく、100%プライベートです。",
    cap_6_title: "高忠実度のマルチフォーマット書き出し",
    cap_6_desc: "安全マージン付きでレイアウトされたPDF、50/50段組みで編集可能なWord（.docx）、Markdownへの直接コピーを即座にダウンロードできます。",
  },
  hi: {
    nav_capabilities: "क्षमताएं",
    info_tab_capabilities: "क्षमताएं",
    cap_1_title: "मल्टी-डॉक्यूमेंट जनरेशन",
    cap_1_desc: "एकपक्षीय NDA, द्विपक्षीय पारस्परिक समझौते, B2B सेवा अनुबंध, गोपनीयता नीतियां और सेवा निपटान विलेख, सभी मौजूदा नियमों के अनुरूप।",
    cap_2_title: "एक साथ द्विभाषी प्रारूपण",
    cap_2_desc: "8 भाषाओं (ES, EN, PT, FR, RU, ZH, JA, HI) में समानांतर रूप से दोहरे कॉलम में जनरेट और एक्सपोर्ट करें, बिना किसी संरेखण गड़बड़ी के।",
    cap_3_title: "डिजिटल हस्ताक्षर और ब्रांड कस्टमाइज़ेशन",
    cap_3_desc: "अपने डिजिटाइज़्ड हस्तलिखित हस्ताक्षर बनाने के लिए एक टच कैनवास, और उच्च रिज़ॉल्यूशन में कंपनी का लेटरहेड या लोगो जोड़ें।",
    cap_4_title: "क्रिप्टोग्राफ़िक अखंडता मुहर",
    cap_4_desc: "रीयल-टाइम SHA-256 हैश स्टैम्पिंग और प्रत्येक दस्तावेज़ के निचले हिस्से में सत्यापन QR कोड, ताकि किसी भी बदलाव का पता लगाया जा सके।",
    cap_5_title: "सर्वर के बिना सुरक्षित सहयोग",
    cap_5_desc: "एक संपीड़ित URL लिंक के माध्यम से पहले से भरे हुए ड्राफ्ट साझा करें: बाहरी डेटाबेस में शून्य भंडारण, 100% निजी।",
    cap_6_title: "उच्च-निष्ठा मल्टी-फॉर्मेट एक्सपोर्ट",
    cap_6_desc: "सुरक्षा मार्जिन के साथ लेआउट किया गया PDF, 50/50 कॉलम में संपादन योग्य Word (.docx), और सीधे Markdown में कॉपी तुरंत डाउनलोड करें।",
  },
};
Object.keys(V5_I18N).forEach(lang => Object.assign(I18N[lang], V5_I18N[lang]));
